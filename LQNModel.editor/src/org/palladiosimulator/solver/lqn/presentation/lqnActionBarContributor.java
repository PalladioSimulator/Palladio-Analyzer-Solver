...
/**
 * This is the action bar contributor for the lqn model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class lqnActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    ...
    protected IAction showPropertiesViewAction = new Action(
            LqnEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {

        @Override
        public void run() {
            try {
                lqnActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
    ...
    protected IAction refreshViewerAction = new Action(
            LqnEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {

        @Override
        public boolean isEnabled() {
            return lqnActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (lqnActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) lqnActionBarContributor.this.activeEditorPart).getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
            }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(LqnEditorPlugin.INSTANCE.getString("_UI_lqnEditor_menu"),
                "org.palladiosimulator.solver.lqnMenuID");
        ...
        //
        this.createChildMenuManager = new MenuManager(LqnEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                LqnEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
