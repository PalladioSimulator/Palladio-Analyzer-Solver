 ...
 * @generated
 */
public class AggregatedUsageContextActionBarContributor extends EditingDomainActionBarContributor
implements ISelectionChangedListener {
            ...
            ContextEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        ...
        public void run()
        {
            try
            {
                AggregatedUsageContextActionBarContributor.this.getPage()
            ...
            ContextEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
        ...
        {
            return AggregatedUsageContextActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run()
        {
            if (AggregatedUsageContextActionBarContributor.this.activeEditorPart instanceof IViewerProvider)
            {
                final Viewer viewer = ((IViewerProvider) AggregatedUsageContextActionBarContributor.this.activeEditorPart)
                        .getViewer();
                if (viewer != null)
                {
                    viewer.refresh();
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                ...
                "org.palladiosimulator.solver.context.aggregatedUsageContextMenuID");
