...
public class EMFHelper {
    ...
    public static EObject loadFromXMIFile(final String fileName) {
        ...
        // }
        // }
        EObject eObject = resource.getContents()
            .iterator()
            .next();
    ...
    private static void registerPackages(final ResourceSet resourceSet) {
        ...
        resourceSet.getPackageRegistry()
            .put(ParameterPackage.eNS_URI, ParameterPackage.eINSTANCE);
        resourceSet.getPackageRegistry()
            .put(ResourceenvironmentPackage.eNS_URI, ResourceenvironmentPackage.eINSTANCE);
        resourceSet.getPackageRegistry()
            .put(ResourcetypePackage.eNS_URI, ResourcetypePackage.eINSTANCE);
        resourceSet.getPackageRegistry()
            .put(RepositoryPackage.eNS_URI, RepositoryPackage.eINSTANCE);
        resourceSet.getPackageRegistry()
            .put(SeffPackage.eNS_URI, SeffPackage.eINSTANCE);
        resourceSet.getPackageRegistry()
