 ...
 * @generated
 */
public class ResultConf95TypeImpl extends MinimalEObjectImpl.Container
		implements ResultConf95Type {
	/**
	...
	public void setJoinVariance(double newJoinVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					LqnPackage.RESULT_CONF95_TYPE__JOIN_VARIANCE,
	...
	public void setJoinWaiting(double newJoinWaiting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					LqnPackage.RESULT_CONF95_TYPE__JOIN_WAITING,
