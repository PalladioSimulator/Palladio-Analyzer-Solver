...
public class PDFPerformanceOps {
    ...
    public ManagedPDF computeIteration(ManagedPDF usage, IProbabilityMassFunction iterations)
    ...
    public ManagedPDF computeAlternative(ManagedPDF leftRU, double leftProbability, ManagedPDF rightRU,
            double rightProbability) throws ProbabilityFunctionException {
        return performOperation(BinaryOperation.ALTERNATIVE, leftRU, leftProbability, rightRU, rightProbability);
    }
    ...
    protected ManagedPDF performOperation(BinaryOperation op, ManagedPDF leftRU, double leftProbability,
            ManagedPDF rightRU, double rightProbability) throws ProbabilityFunctionException {
