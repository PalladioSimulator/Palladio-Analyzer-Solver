...
public class ActivityDefTypeItemProvider extends ActivityDefBaseItemProvider {
    ...
    protected void addBoundToEntryPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_ActivityDefType_boundToEntry_feature",
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ActivityDefType_type")
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(lqnPackage.Literals.ACTIVITY_DEF_TYPE__CALL_LIST,
                lqnFactory.eINSTANCE.createCallListType()));

        newChildDescriptors.add(this.createChildParameter(lqnPackage.Literals.ACTIVITY_DEF_TYPE__GROUP,
