...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.solver.lqn.ResultConf95Type}
...
public class ResultConf95TypeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
     ...
     * @generated
     */
    public ResultConf95TypeItemProvider(final AdapterFactory adapterFactory) {
    ...
    protected void addJoinVariancePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_ResultConf95Type_joinVariance_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_ResultConf95Type_joinVariance_feature",
    ...
    protected void addJoinWaitingPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_ResultConf95Type_joinWaiting_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_ResultConf95Type_joinWaiting_feature",
                        "_UI_ResultConf95Type_type"),
    ...
    protected void addWaitingPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_ResultConf95Type_waiting_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_ResultConf95Type_waiting_feature",
                        "_UI_ResultConf95Type_type"),
                lqnPackage.Literals.RESULT_CONF95_TYPE__WAITING, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }

    /**
     * This returns ResultConf95Type.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/ResultConf95Type"));
    }
    ...
    public String getText(final Object object) {
        final Object labelValue = ((ResultConf95Type) object).getJoinVariance();
        final String label = labelValue == null ? null : labelValue.toString();
        return label == null || label.length() == 0 ? this.getString("_UI_ResultConf95Type_type")
                : this.getString("_UI_ResultConf95Type_type") + " " + label;
    }
