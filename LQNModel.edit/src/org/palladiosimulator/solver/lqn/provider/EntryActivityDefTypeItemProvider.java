...
public class EntryActivityDefTypeItemProvider extends ActivityDefBaseItemProvider {
    ...
    protected void addFirstActivityPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_EntryActivityDefType_firstActivity_feature",
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_EntryActivityDefType_type")
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(LqnPackage.Literals.ENTRY_ACTIVITY_DEF_TYPE__CALL_LIST,
                LqnFactory.eINSTANCE.createCallListType()));

        newChildDescriptors.add(this.createChildParameter(LqnPackage.Literals.ENTRY_ACTIVITY_DEF_TYPE__GROUP,
