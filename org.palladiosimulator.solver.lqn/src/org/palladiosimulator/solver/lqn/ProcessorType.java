...
public interface ProcessorType extends EObject {
    ...
    /**
     * Returns the value of the '<em><b>Group</b></em>' containment reference list. The list
     * contents are of type {@link org.palladiosimulator.solver.lqn.GroupType}. <!-- begin-user-doc
     * -->
     * <p>
     * If the meaning of the '<em>Group</em>' containment reference list isn't clear, there really
