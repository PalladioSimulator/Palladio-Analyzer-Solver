 ...
 * <ul>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getResultConf95 <em>Result Conf95
 * </em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getResultConf99 <em>Result Conf99
 * </em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getLossProbability <em>Loss
 * Probability</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getOpenWaitTime <em>Open Wait Time
 * </em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase1ProcWaiting <em>Phase1 Proc
 * Waiting</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase1ServiceTime <em>Phase1
 * Service Time</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase1ServiceTimeVariance <em>
 * Phase1 Service Time Variance</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase1Utilization <em>Phase1
 * Utilization</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase1Waiting <em>Phase1 Waiting
 * </em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase1WaitingVariance <em>Phase1
 * Waiting Variance</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase2ProcWaiting <em>Phase2 Proc
 * Waiting</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase2ServiceTime <em>Phase2
 * Service Time</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase2ServiceTimeVariance <em>
 * Phase2 Service Time Variance</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase2Utilization <em>Phase2
 * Utilization</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase2Waiting <em>Phase2 Waiting
 * </em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase2WaitingVariance <em>Phase2
 * Waiting Variance</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase3ProcWaiting <em>Phase3 Proc
 * Waiting</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase3ServiceTime <em>Phase3
 * Service Time</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase3ServiceTimeVariance <em>
 * Phase3 Service Time Variance</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase3Utilization <em>Phase3
 * Utilization</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase3Waiting <em>Phase3 Waiting
 * </em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getPhase3WaitingVariance <em>Phase3
 * Waiting Variance</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getProbExceedMaxServiceTime <em>Prob
 * Exceed Max Service Time</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getProcUtilization <em>Proc
 * Utilization</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getProcWaiting <em>Proc Waiting
 * </em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getRwlockReaderHolding <em>Rwlock
 * Reader Holding</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getRwlockReaderUtilization <em>
 * Rwlock Reader Utilization</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getRwlockReaderWaiting <em>Rwlock
 * Reader Waiting</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getRwlockReaderWaitingVariance <em>
 * Rwlock Reader Waiting Variance</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getRwlockWriterHolding <em>Rwlock
 * Writer Holding</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getRwlockWriterUtilization <em>
 * Rwlock Writer Utilization</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getRwlockWriterWaiting <em>Rwlock
 * Writer Waiting</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getRwlockWriterWaitingVariance <em>
 * Rwlock Writer Waiting Variance</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getSemaphoreUtilization <em>
 * Semaphore Utilization</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getSemaphoreWaiting <em>Semaphore
 * Waiting</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getSemaphoreWaitingVariance <em>
 * Semaphore Waiting Variance</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getServiceTime <em>Service Time
 * </em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getServiceTimeVariance <em>Service
 * Time Variance</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getSquaredCoeffVariation <em>Squared
 * Coeff Variation</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getThroughput <em>Throughput</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getThroughputBound <em>Throughput
 * Bound</em>}</li>
 ...
 * <li>{@link org.palladiosimulator.solver.lqn.OutputResultType#getWaitingVariance <em>Waiting
 * Variance</em>}</li>
 * </ul>
 * </p>
 *
...
public interface OutputResultType extends EObject {
    ...
    /**
     * Unsets the value of the '{@link org.palladiosimulator.solver.lqn.OutputResultType#getWaiting
     * <em>Waiting</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #isSetWaiting()
     * @see #getWaiting()
