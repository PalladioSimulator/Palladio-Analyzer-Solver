...
public interface PlotControlType extends EObject {
     ...
     *        "kind='element' name='first-plot' namespace='##targetNamespace'"
     * @generated
     */
    FirstPlotType getFirstPlot();

    /**
     * Sets the value of the '{@link org.palladiosimulator.solver.lqn.PlotControlType#getFirstPlot
     * <em>First Plot</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>First Plot</em>' containment reference.
     * @see #getFirstPlot()
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Plot</b></em>' containment reference list. The list contents
     * are of type {@link org.palladiosimulator.solver.lqn.PlotType}. <!-- begin-user-doc -->
     * <p>
