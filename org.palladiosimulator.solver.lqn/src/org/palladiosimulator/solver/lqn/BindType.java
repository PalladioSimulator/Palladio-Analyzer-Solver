...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Bind Type</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
 ...
 * <li>{@link org.palladiosimulator.solver.lqn.BindType#getProcessorBinding <em>Processor Binding
 * </em>}</li>
...
public interface BindType extends EObject {
     ...
     * contents are of type {@link org.palladiosimulator.solver.lqn.ParameterType}. <!--
     * begin-user-doc -->
     * <p>
    ...
    /**
     * Returns the value of the '<em><b>Processor Binding</b></em>' containment reference list. The
     * list contents are of type {@link org.palladiosimulator.solver.lqn.ProcessorBindingType}. <!--
     * begin-user-doc -->
     * <p>
     ...
     * @model containment="true" extendedMetaData=
     *        "kind='element' name='processor-binding' namespace='##targetNamespace'"
     * @generated
     */
    EList<ProcessorBindingType> getProcessorBinding();

    /**
     * Returns the value of the '<em><b>Port Binding</b></em>' containment reference list. The list
     * contents are of type {@link org.palladiosimulator.solver.lqn.PortBindingType}. <!--
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Port Binding</em>' containment reference list isn't clear, there
     * really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
     ...
     * @model containment="true" extendedMetaData=
     *        "kind='element' name='port-binding' namespace='##targetNamespace'"
     * @generated
     */
