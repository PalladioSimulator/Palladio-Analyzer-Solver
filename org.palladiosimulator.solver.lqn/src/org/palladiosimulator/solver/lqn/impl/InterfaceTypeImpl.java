 ...
 * @generated
 */
public class InterfaceTypeImpl extends MinimalEObjectImpl.Container implements
		InterfaceType {
	/**
	...
	public EList<InPortType> getInPort() {
		if (inPort == null) {
			inPort = new EObjectContainmentEList<InPortType>(InPortType.class,
					this, LqnPackage.INTERFACE_TYPE__IN_PORT);
		}
		return inPort;
	}
	...
	public EList<OutPortType> getOutPort() {
		if (outPort == null) {
			outPort = new EObjectContainmentEList<OutPortType>(
					OutPortType.class, this,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case LqnPackage.INTERFACE_TYPE__OUT_PORT:
			return ((InternalEList<?>) getOutPort())
