...
public class EntryTypeImpl extends MinimalEObjectImpl.Container implements EntryType {
	...
	/**
	 * This is true if the Rwlock attribute has been set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	public void setRwlock(RWLockType newRwlock) {
		...
		rwlockESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.ENTRY_TYPE__RWLOCK, oldRwlock, rwlock, !oldRwlockESet));
	}
	...
	public void unsetRwlock() {
		...
		rwlockESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LqnPackage.ENTRY_TYPE__RWLOCK, oldRwlock, RWLOCK_EDEFAULT, oldRwlockESet));
	}
	...
	public String toString() {
		...
		if (rwlockESet) result.append(rwlock); else result.append("<unset>");
