...
public class LqnPackageImpl extends EPackageImpl implements LqnPackage {
	...
	public void initializePackageContents() {
		...
		initEClass(activityDefBaseEClass, ActivityDefBase.class, "ActivityDefBase", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getActivityDefBase_ServiceTimeDistribution(), this.getOutputDistributionType(), null,
				"serviceTimeDistribution", null, 0, -1, ActivityDefBase.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getActivityDefBase_ResultActivity(), this.getOutputResultType(), null, "resultActivity", null, 0,
				-1, ActivityDefBase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getActivityDefBase_CallOrder(), this.getCallOrderType(), "callOrder", "STOCHASTIC", 0, 1,
				ActivityDefBase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getActivityDefBase_HostDemandCvsq(), this.getSrvnFloat(), "hostDemandCvsq", null, 0, 1,
				ActivityDefBase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getActivityDefBase_HostDemandMean(), this.getSrvnFloat(), "hostDemandMean", null, 1, 1,
				ActivityDefBase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getActivityDefBase_MaxServiceTime(), this.getSrvnFloat(), "maxServiceTime", null, 0, 1,
				ActivityDefBase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getActivityDefBase_Name(), theXMLTypePackage.getString(), "name", null, 1, 1,
				ActivityDefBase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getActivityDefBase_ThinkTime(), this.getSrvnFloat(), "thinkTime", null, 0, 1,
				ActivityDefBase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(activityDefTypeEClass, ActivityDefType.class, "ActivityDefType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getActivityDefType_CallList(), this.getCallListType(), null, "callList", null, 0, -1,
				ActivityDefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getActivityDefType_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1,
				ActivityDefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getActivityDefType_SynchCall(), this.getActivityMakingCallType(), null, "synchCall", null, 0, -1,
				ActivityDefType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getActivityDefType_AsynchCall(), this.getActivityMakingCallType(), null, "asynchCall", null, 0,
				-1, ActivityDefType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getActivityDefType_BoundToEntry(), theXMLTypePackage.getString(), "boundToEntry", null, 0, 1,
				ActivityDefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(activityGraphBaseEClass, ActivityGraphBase.class, "ActivityGraphBase", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getActivityGraphBase_Activity(), this.getActivityDefType(), null, "activity", null, 1, -1,
				ActivityGraphBase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getActivityGraphBase_Precedence(), this.getPrecedenceType(), null, "precedence", null, 0, -1,
				ActivityGraphBase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(activityListTypeEClass, ActivityListType.class, "ActivityListType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getActivityListType_Activity(), this.getActivityType(), null, "activity", null, 1, -1,
				ActivityListType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(activityLoopListTypeEClass, ActivityLoopListType.class, "ActivityLoopListType", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getActivityLoopListType_Activity(), this.getActivityLoopType(), null, "activity", null, 1, -1,
				ActivityLoopListType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getActivityLoopListType_End(), theXMLTypePackage.getString(), "end", null, 0, 1,
				ActivityLoopListType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(activityLoopTypeEClass, ActivityLoopType.class, "ActivityLoopType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getActivityLoopType_Count(), this.getSrvnFloat(), "count", null, 1, 1, ActivityLoopType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(activityMakingCallTypeEClass, ActivityMakingCallType.class, "ActivityMakingCallType", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getActivityMakingCallType_CallsMean(), this.getSrvnFloat(), "callsMean", null, 1, 1,
				ActivityMakingCallType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(activityOrTypeEClass, ActivityOrType.class, "ActivityOrType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getActivityOrType_Prob(), theXMLTypePackage.getString(), "prob", "1", 0, 1, ActivityOrType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(activityPhasesTypeEClass, ActivityPhasesType.class, "ActivityPhasesType", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getActivityPhasesType_CallList(), this.getCallListType(), null, "callList", null, 0, -1,
				ActivityPhasesType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getActivityPhasesType_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1,
				ActivityPhasesType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				!IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getActivityPhasesType_SynchCall(), this.getActivityMakingCallType(), null, "synchCall", null, 0,
				-1, ActivityPhasesType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getActivityPhasesType_AsynchCall(), this.getActivityMakingCallType(), null, "asynchCall", null,
				0, -1, ActivityPhasesType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getActivityPhasesType_Phase(), this.getPhaseType(), "phase", null, 1, 1,
				ActivityPhasesType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(activityTypeEClass, ActivityType.class, "ActivityType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getActivityType_Name(), theXMLTypePackage.getString(), "name", null, 1, 1, ActivityType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(andJoinListTypeEClass, AndJoinListType.class, "AndJoinListType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAndJoinListType_ResultJoinDelay(), this.getOutputResultJoinDelayType(), null,
				"resultJoinDelay", null, 0, -1, AndJoinListType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAndJoinListType_ServiceTimeDistribution(), this.getOutputDistributionType(), null,
				"serviceTimeDistribution", null, 0, -1, AndJoinListType.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAndJoinListType_Activity(), this.getActivityType(), null, "activity", null, 1, -1,
				AndJoinListType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAndJoinListType_Quorum(), theXMLTypePackage.getNonNegativeInteger(), "quorum", "0", 0, 1,
				AndJoinListType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(asynchCallTypeEClass, AsynchCallType.class, "AsynchCallType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAsynchCallType_Dest(), theXMLTypePackage.getString(), "dest", null, 1, 1,
				AsynchCallType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(bindTypeEClass, BindType.class, "BindType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBindType_Parameter(), this.getParameterType(), null, "parameter", null, 0, -1, BindType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBindType_ProcessorBinding(), this.getProcessorBindingType(), null, "processorBinding", null,
				0, -1, BindType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBindType_PortBinding(), this.getPortBindingType(), null, "portBinding", null, 0, -1,
				BindType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(callListTypeEClass, CallListType.class, "CallListType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCallListType_SynchCall(), this.getSynchCallType(), null, "synchCall", null, 0, -1,
				CallListType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCallListType_AsynchCall(), this.getAsynchCallType(), null, "asynchCall", null, 0, -1,
				CallListType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDocumentRoot_XSISchemaLocation(), ecorePackage.getEStringToStringMapEntry(), null,
				...
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDocumentRoot_LqnCore(), this.getLqnCoreType(), null, "lqnCore", null, 0, -2, null,
				IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				IS_DERIVED, IS_ORDERED);
		initEReference(getDocumentRoot_LqnModel(), this.getLqnModelType(), null, "lqnModel", null, 0, -2, null,
				IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				IS_DERIVED, IS_ORDERED);

		initEClass(entryActivityDefTypeEClass, EntryActivityDefType.class, "EntryActivityDefType", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEntryActivityDefType_CallList(), this.getCallListType(), null, "callList", null, 0, -1,
				EntryActivityDefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntryActivityDefType_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1,
				EntryActivityDefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				!IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEntryActivityDefType_SynchCall(), this.getActivityMakingCallType(), null, "synchCall", null,
				0, -1, EntryActivityDefType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getEntryActivityDefType_AsynchCall(), this.getActivityMakingCallType(), null, "asynchCall", null,
				0, -1, EntryActivityDefType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntryActivityDefType_FirstActivity(), theXMLTypePackage.getString(), "firstActivity", null, 0,
				1, EntryActivityDefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(entryActivityGraphEClass, EntryActivityGraph.class, "EntryActivityGraph", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEntryActivityGraph_ReplyActivity(), this.getReplyActivityType(), null, "replyActivity", null,
				1, -1, EntryActivityGraph.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(entryMakingCallTypeEClass, EntryMakingCallType.class, "EntryMakingCallType", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEntryMakingCallType_Prob(), this.getSrvnFloat(), "prob", null, 1, 1,
				EntryMakingCallType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(entryTypeEClass, EntryType.class, "EntryType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEntryType_ResultEntry(), this.getOutputResultType(), null, "resultEntry", null, 0, -1,
				EntryType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEntryType_ServiceTimeDistribution(), this.getOutputEntryDistributionType(), null,
				"serviceTimeDistribution", null, 0, -1, EntryType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEntryType_Forwarding(), this.getEntryMakingCallType(), null, "forwarding", null, 0, -1,
				EntryType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEntryType_EntryActivityGraph(), this.getEntryActivityGraph(), null, "entryActivityGraph",
				null, 0, 1, EntryType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEntryType_EntryPhaseActivities(), this.getPhaseActivities(), null, "entryPhaseActivities",
				null, 0, 1, EntryType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntryType_Name(), theXMLTypePackage.getString(), "name", null, 1, 1, EntryType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntryType_OpenArrivalRate(), this.getSrvnFloat(), "openArrivalRate", null, 0, 1,
				EntryType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntryType_Priority(), theXMLTypePackage.getInt(), "priority", null, 0, 1, EntryType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntryType_Rwlock(), this.getRWLockType(), "rwlock", null, 0, 1, EntryType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntryType_Semaphore(), this.getSemaphoreType(), "semaphore", null, 0, 1, EntryType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntryType_Type(), this.getTypeType(), "type", null, 1, 1, EntryType.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(fanInTypeEClass, FanInType.class, "FanInType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFanInType_Source(), theXMLTypePackage.getString(), "source", null, 1, 1, FanInType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFanInType_Value(), theXMLTypePackage.getNonNegativeInteger(), "value", null, 1, 1,
				FanInType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(fanOutTypeEClass, FanOutType.class, "FanOutType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFanOutType_Dest(), theXMLTypePackage.getString(), "dest", null, 1, 1, FanOutType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFanOutType_Value(), theXMLTypePackage.getNonNegativeInteger(), "value", null, 1, 1,
				FanOutType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(firstPlotTypeEClass, FirstPlotType.class, "FirstPlotType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFirstPlotType_Variable(), theXMLTypePackage.getString(), "variable", null, 0, 1,
				FirstPlotType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(groupTypeEClass, GroupType.class, "GroupType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getGroupType_ResultGroup(), this.getOutputResultType(), null, "resultGroup", null, 0, -1,
				GroupType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGroupType_Task(), this.getTaskType(), null, "task", null, 1, -1, GroupType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGroupType_Cap(), theXMLTypePackage.getBoolean(), "cap", "false", 0, 1, GroupType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGroupType_Name(), theXMLTypePackage.getString(), "name", null, 1, 1, GroupType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGroupType_Share(), this.getSrvnFloat(), "share", null, 1, 1, GroupType.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(histogramBinTypeEClass, HistogramBinType.class, "HistogramBinType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getHistogramBinType_Begin(), theXMLTypePackage.getDouble(), "begin", null, 1, 1,
				HistogramBinType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getHistogramBinType_Conf95(), theXMLTypePackage.getDouble(), "conf95", null, 0, 1,
				HistogramBinType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getHistogramBinType_Conf99(), theXMLTypePackage.getDouble(), "conf99", null, 0, 1,
				HistogramBinType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getHistogramBinType_End(), theXMLTypePackage.getDouble(), "end", null, 0, 1,
				HistogramBinType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getHistogramBinType_Prob(), theXMLTypePackage.getDouble(), "prob", null, 1, 1,
				HistogramBinType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(inPortTypeEClass, InPortType.class, "InPortType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getInPortType_ConnectFrom(), this.getConnectFromType(), "connectFrom", null, 0, 1,
				InPortType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getInPortType_Description(), theXMLTypePackage.getString(), "description", null, 0, 1,
				InPortType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getInPortType_Name(), theXMLTypePackage.getString(), "name", null, 1, 1, InPortType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(interfaceTypeEClass, InterfaceType.class, "InterfaceType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getInterfaceType_InPort(), this.getInPortType(), null, "inPort", null, 0, -1,
				InterfaceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInterfaceType_OutPort(), this.getOutPortType(), null, "outPort", null, 0, -1,
				InterfaceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(lqnCoreTypeEClass, LqnCoreType.class, "LqnCoreType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLqnCoreType_Processor(), this.getProcessorType(), null, "processor", null, 1, -1,
				LqnCoreType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLqnCoreType_Slot(), this.getSlotType(), null, "slot", null, 0, -1, LqnCoreType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(lqnModelTypeEClass, LqnModelType.class, "LqnModelType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLqnModelType_RunControl(), this.getRunControlType(), null, "runControl", null, 0, 1,
				LqnModelType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLqnModelType_PlotControl(), this.getPlotControlType(), null, "plotControl", null, 0, 1,
				LqnModelType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLqnModelType_SolverParams(), this.getSolverParamsType(), null, "solverParams", null, 1, 1,
				LqnModelType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLqnModelType_Processor(), this.getProcessorType(), null, "processor", null, 1, -1,
				LqnModelType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLqnModelType_Slot(), this.getSlotType(), null, "slot", null, 0, -1, LqnModelType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLqnModelType_Lqx(), theXMLTypePackage.getString(), "lqx", null, 0, 1, LqnModelType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLqnModelType_Description(), theXMLTypePackage.getString(), "description", null, 0, 1,
				LqnModelType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLqnModelType_LqnSchemaVersion(), theXMLTypePackage.getDecimal(), "lqnSchemaVersion", "1.0", 0,
				1, LqnModelType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLqnModelType_LqncoreSchemaVersion(), theXMLTypePackage.getDecimal(), "lqncoreSchemaVersion",
				"1.1", 0, 1, LqnModelType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLqnModelType_Name(), theXMLTypePackage.getString(), "name", null, 0, 1, LqnModelType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLqnModelType_XmlDebug(), theXMLTypePackage.getBoolean(), "xmlDebug", null, 0, 1,
				LqnModelType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(makingCallTypeEClass, MakingCallType.class, "MakingCallType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMakingCallType_ResultCall(), this.getOutputResultType(), null, "resultCall", null, 0, -1,
				MakingCallType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMakingCallType_Dest(), theXMLTypePackage.getString(), "dest", null, 1, 1,
				MakingCallType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(mvaInfoTypeEClass, MvaInfoType.class, "MvaInfoType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMvaInfoType_Core(), theXMLTypePackage.getNonNegativeInteger(), "core", null, 1, 1,
				MvaInfoType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getMvaInfoType_Faults(), theXMLTypePackage.getNonNegativeInteger(), "faults", null, 0, 1,
				MvaInfoType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getMvaInfoType_Step(), theXMLTypePackage.getDouble(), "step", null, 1, 1, MvaInfoType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMvaInfoType_StepSquared(), theXMLTypePackage.getDouble(), "stepSquared", null, 0, 1,
				MvaInfoType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getMvaInfoType_Submodels(), theXMLTypePackage.getNonNegativeInteger(), "submodels", null, 1, 1,
				MvaInfoType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getMvaInfoType_Wait(), theXMLTypePackage.getDouble(), "wait", null, 1, 1, MvaInfoType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMvaInfoType_WaitSquared(), theXMLTypePackage.getDouble(), "waitSquared", null, 0, 1,
				MvaInfoType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(orListTypeEClass, OrListType.class, "OrListType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getOrListType_Activity(), this.getActivityOrType(), null, "activity", null, 1, -1,
				OrListType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(outPortTypeEClass, OutPortType.class, "OutPortType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getOutPortType_ConnectTo(), this.getConnectToType(), "connectTo", null, 0, 1, OutPortType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutPortType_Description(), theXMLTypePackage.getString(), "description", null, 0, 1,
				OutPortType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutPortType_Name(), theXMLTypePackage.getString(), "name", null, 1, 1, OutPortType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(outputDistributionTypeEClass, OutputDistributionType.class, "OutputDistributionType", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getOutputDistributionType_UnderflowBin(), this.getHistogramBinType(), null, "underflowBin", null,
				0, 1, OutputDistributionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOutputDistributionType_HistogramBin(), this.getHistogramBinType(), null, "histogramBin", null,
				0, -1, OutputDistributionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOutputDistributionType_OverflowBin(), this.getHistogramBinType(), null, "overflowBin", null,
				0, 1, OutputDistributionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputDistributionType_BinSize(), theXMLTypePackage.getDouble(), "binSize", null, 0, 1,
				OutputDistributionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputDistributionType_Kurtosis(), theXMLTypePackage.getDouble(), "kurtosis", null, 0, 1,
				OutputDistributionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputDistributionType_Max(), theXMLTypePackage.getDouble(), "max", null, 1, 1,
				OutputDistributionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputDistributionType_Mean(), theXMLTypePackage.getDouble(), "mean", null, 0, 1,
				OutputDistributionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputDistributionType_MidPoint(), theXMLTypePackage.getDouble(), "midPoint", null, 0, 1,
				OutputDistributionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputDistributionType_Min(), theXMLTypePackage.getDouble(), "min", null, 1, 1,
				OutputDistributionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputDistributionType_NumberBins(), theXMLTypePackage.getNonNegativeInteger(), "numberBins",
				"20", 0, 1, OutputDistributionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputDistributionType_Skew(), theXMLTypePackage.getDouble(), "skew", null, 0, 1,
				OutputDistributionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputDistributionType_StdDev(), theXMLTypePackage.getDouble(), "stdDev", null, 0, 1,
				OutputDistributionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(outputEntryDistributionTypeEClass, OutputEntryDistributionType.class, "OutputEntryDistributionType",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getOutputEntryDistributionType_Phase(), theXMLTypePackage.getNonNegativeInteger(), "phase", null,
				1, 1, OutputEntryDistributionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(outputResultJoinDelayTypeEClass, OutputResultJoinDelayType.class, "OutputResultJoinDelayType",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getOutputResultJoinDelayType_ResultConf95(), this.getResultConf95Type(), null, "resultConf95",
				null, 0, 1, OutputResultJoinDelayType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOutputResultJoinDelayType_ResultConf99(), this.getResultConf99Type(), null, "resultConf99",
				null, 0, 1, OutputResultJoinDelayType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultJoinDelayType_JoinVariance(), theXMLTypePackage.getDouble(), "joinVariance", null,
				0, 1, OutputResultJoinDelayType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultJoinDelayType_JoinWaiting(), theXMLTypePackage.getDouble(), "joinWaiting", null,
				0, 1, OutputResultJoinDelayType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(outputResultTypeEClass, OutputResultType.class, "OutputResultType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getOutputResultType_ResultConf95(), this.getResultConf95Type1(), null, "resultConf95", null, 0,
				1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOutputResultType_ResultConf99(), this.getResultConf99Type1(), null, "resultConf99", null, 0,
				1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_LossProbability(), theXMLTypePackage.getDouble(), "lossProbability", null, 0,
				1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_OpenWaitTime(), theXMLTypePackage.getDouble(), "openWaitTime", null, 0, 1,
				OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase1ProcWaiting(), theXMLTypePackage.getDouble(), "phase1ProcWaiting",
				null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase1ServiceTime(), theXMLTypePackage.getDouble(), "phase1ServiceTime",
				null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase1ServiceTimeVariance(), theXMLTypePackage.getDouble(),
				"phase1ServiceTimeVariance", null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase1Utilization(), theXMLTypePackage.getDouble(), "phase1Utilization",
				null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase1Waiting(), theXMLTypePackage.getDouble(), "phase1Waiting", null, 0, 1,
				OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase1WaitingVariance(), theXMLTypePackage.getDouble(),
				"phase1WaitingVariance", null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase2ProcWaiting(), theXMLTypePackage.getDouble(), "phase2ProcWaiting",
				null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase2ServiceTime(), theXMLTypePackage.getDouble(), "phase2ServiceTime",
				null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase2ServiceTimeVariance(), theXMLTypePackage.getDouble(),
				"phase2ServiceTimeVariance", null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase2Utilization(), theXMLTypePackage.getDouble(), "phase2Utilization",
				null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase2Waiting(), theXMLTypePackage.getDouble(), "phase2Waiting", null, 0, 1,
				OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase2WaitingVariance(), theXMLTypePackage.getDouble(),
				"phase2WaitingVariance", null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase3ProcWaiting(), theXMLTypePackage.getDouble(), "phase3ProcWaiting",
				null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase3ServiceTime(), theXMLTypePackage.getDouble(), "phase3ServiceTime",
				null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase3ServiceTimeVariance(), theXMLTypePackage.getDouble(),
				"phase3ServiceTimeVariance", null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase3Utilization(), theXMLTypePackage.getDouble(), "phase3Utilization",
				null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase3Waiting(), theXMLTypePackage.getDouble(), "phase3Waiting", null, 0, 1,
				OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Phase3WaitingVariance(), theXMLTypePackage.getDouble(),
				"phase3WaitingVariance", null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_ProbExceedMaxServiceTime(), theXMLTypePackage.getDouble(),
				"probExceedMaxServiceTime", null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_ProcUtilization(), theXMLTypePackage.getDouble(), "procUtilization", null, 0,
				1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_ProcWaiting(), theXMLTypePackage.getDouble(), "procWaiting", null, 0, 1,
				OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_RwlockReaderHolding(), theXMLTypePackage.getDouble(), "rwlockReaderHolding",
				null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_RwlockReaderUtilization(), theXMLTypePackage.getDouble(),
				"rwlockReaderUtilization", null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_RwlockReaderWaiting(), theXMLTypePackage.getDouble(), "rwlockReaderWaiting",
				null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_RwlockReaderWaitingVariance(), theXMLTypePackage.getDouble(),
				"rwlockReaderWaitingVariance", null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_RwlockWriterHolding(), theXMLTypePackage.getDouble(), "rwlockWriterHolding",
				null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_RwlockWriterUtilization(), theXMLTypePackage.getDouble(),
				"rwlockWriterUtilization", null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_RwlockWriterWaiting(), theXMLTypePackage.getDouble(), "rwlockWriterWaiting",
				null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_RwlockWriterWaitingVariance(), theXMLTypePackage.getDouble(),
				"rwlockWriterWaitingVariance", null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_SemaphoreUtilization(), theXMLTypePackage.getDouble(),
				"semaphoreUtilization", null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_SemaphoreWaiting(), theXMLTypePackage.getDouble(), "semaphoreWaiting", null,
				0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_SemaphoreWaitingVariance(), theXMLTypePackage.getDouble(),
				"semaphoreWaitingVariance", null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_ServiceTime(), theXMLTypePackage.getDouble(), "serviceTime", null, 0, 1,
				OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_ServiceTimeVariance(), theXMLTypePackage.getDouble(), "serviceTimeVariance",
				null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_SquaredCoeffVariation(), theXMLTypePackage.getDouble(),
				"squaredCoeffVariation", null, 0, 1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Throughput(), theXMLTypePackage.getDouble(), "throughput", null, 0, 1,
				OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_ThroughputBound(), theXMLTypePackage.getDouble(), "throughputBound", null, 0,
				1, OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Utilization(), theXMLTypePackage.getDouble(), "utilization", null, 0, 1,
				OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputResultType_Waiting(), theXMLTypePackage.getDouble(), "waiting", null, 0, 1,
				OutputResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		...
		initEClass(paraTypeEClass, ParaType.class, "ParaType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getParaType_StartValue(), theXMLTypePackage.getInt(), "startValue", null, 0, 1, ParaType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getParaType_EndValue(), theXMLTypePackage.getInt(), "endValue", null, 0, 1, ParaType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getParaType_StepValue(), theXMLTypePackage.getInt(), "stepValue", null, 0, 1, ParaType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getParaType_Value(), theXMLTypePackage.getInt(), "value", null, 0, -1, ParaType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(phaseActivitiesEClass, PhaseActivities.class, "PhaseActivities", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPhaseActivities_Activity(), this.getActivityPhasesType(), null, "activity", null, 1, 3,
				PhaseActivities.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(plotControlTypeEClass, PlotControlType.class, "PlotControlType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPlotControlType_FirstPlot(), this.getFirstPlotType(), null, "firstPlot", null, 1, 1,
				PlotControlType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPlotControlType_Plot(), this.getPlotType(), null, "plot", null, 1, -1, PlotControlType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(plotTypeEClass, PlotType.class, "PlotType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPlotType_Variable(), theXMLTypePackage.getString(), "variable", null, 0, 1, PlotType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(portBindingTypeEClass, PortBindingType.class, "PortBindingType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPortBindingType_Source(), theXMLTypePackage.getString(), "source", null, 1, 1,
				PortBindingType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getPortBindingType_Target(), theXMLTypePackage.getString(), "target", null, 1, 1,
				PortBindingType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(pragmaTypeEClass, PragmaType.class, "PragmaType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPragmaType_Param(), theXMLTypePackage.getString(), "param", null, 1, 1, PragmaType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPragmaType_Value(), theXMLTypePackage.getString(), "value", null, 1, 1, PragmaType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(precedenceTypeEClass, PrecedenceType.class, "PrecedenceType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPrecedenceType_Pre(), this.getSingleActivityListType(), null, "pre", null, 0, 1,
				PrecedenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPrecedenceType_PreOR(), this.getActivityListType(), null, "preOR", null, 0, 1,
				PrecedenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPrecedenceType_PreAND(), this.getAndJoinListType(), null, "preAND", null, 0, 1,
				PrecedenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPrecedenceType_Post(), this.getSingleActivityListType(), null, "post", null, 0, 1,
				PrecedenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPrecedenceType_PostOR(), this.getOrListType(), null, "postOR", null, 0, 1,
				PrecedenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPrecedenceType_PostAND(), this.getActivityListType(), null, "postAND", null, 0, 1,
				PrecedenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPrecedenceType_PostLOOP(), this.getActivityLoopListType(), null, "postLOOP", null, 0, 1,
				PrecedenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(processorBindingTypeEClass, ProcessorBindingType.class, "ProcessorBindingType", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getProcessorBindingType_Source(), theXMLTypePackage.getString(), "source", null, 1, 1,
				ProcessorBindingType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProcessorBindingType_Target(), theXMLTypePackage.getString(), "target", null, 1, 1,
				ProcessorBindingType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(processorTypeEClass, ProcessorType.class, "ProcessorType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getProcessorType_ResultProcessor(), this.getOutputResultType(), null, "resultProcessor", null, 0,
				-1, ProcessorType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProcessorType_Group(), this.getGroupType(), null, "group", null, 0, -1, ProcessorType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProcessorType_Task(), this.getTaskType(), null, "task", null, 0, -1, ProcessorType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProcessorType_Multiplicity(), this.getSrvnNonNegativeInteger(), "multiplicity", "1", 0, 1,
				ProcessorType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getProcessorType_Name(), theXMLTypePackage.getString(), "name", null, 1, 1, ProcessorType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProcessorType_Quantum(), this.getSrvnFloat(), "quantum", "0", 0, 1, ProcessorType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProcessorType_Replication(), theXMLTypePackage.getNonNegativeInteger(), "replication", "1", 0,
				1, ProcessorType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getProcessorType_Scheduling(), this.getSchedulingType(), "scheduling", "fcfs", 0, 1,
				ProcessorType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getProcessorType_SpeedFactor(), this.getSrvnFloat(), "speedFactor", "1", 0, 1,
				ProcessorType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(replyActivityTypeEClass, ReplyActivityType.class, "ReplyActivityType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getReplyActivityType_Name(), theXMLTypePackage.getString(), "name", null, 1, 1,
				ReplyActivityType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(replyEntryTypeEClass, ReplyEntryType.class, "ReplyEntryType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getReplyEntryType_ReplyActivity(), this.getReplyActivityType(), null, "replyActivity", null, 1,
				-1, ReplyEntryType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getReplyEntryType_Name(), theXMLTypePackage.getString(), "name", null, 1, 1,
				ReplyEntryType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(resultConf95TypeEClass, ResultConf95Type.class, "ResultConf95Type", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getResultConf95Type_JoinVariance(), theXMLTypePackage.getDouble(), "joinVariance", null, 0, 1,
				ResultConf95Type.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type_JoinWaiting(), theXMLTypePackage.getDouble(), "joinWaiting", null, 0, 1,
				ResultConf95Type.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(resultConf95Type1EClass, ResultConf95Type1.class, "ResultConf95Type1", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getResultConf95Type1_LossProbability(), theXMLTypePackage.getDouble(), "lossProbability", null,
				0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_OpenWaitTime(), theXMLTypePackage.getDouble(), "openWaitTime", null, 0, 1,
				ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase1ProcWaiting(), theXMLTypePackage.getDouble(), "phase1ProcWaiting",
				null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase1ServiceTime(), theXMLTypePackage.getDouble(), "phase1ServiceTime",
				null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase1ServiceTimeVariance(), theXMLTypePackage.getDouble(),
				"phase1ServiceTimeVariance", null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase1Utilization(), theXMLTypePackage.getDouble(), "phase1Utilization",
				null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase1Waiting(), theXMLTypePackage.getDouble(), "phase1Waiting", null, 0, 1,
				ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase1WaitingVariance(), theXMLTypePackage.getDouble(),
				"phase1WaitingVariance", null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase2ProcWaiting(), theXMLTypePackage.getDouble(), "phase2ProcWaiting",
				null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase2ServiceTime(), theXMLTypePackage.getDouble(), "phase2ServiceTime",
				null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase2ServiceTimeVariance(), theXMLTypePackage.getDouble(),
				"phase2ServiceTimeVariance", null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase2Utilization(), theXMLTypePackage.getDouble(), "phase2Utilization",
				null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase2Waiting(), theXMLTypePackage.getDouble(), "phase2Waiting", null, 0, 1,
				ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase2WaitingVariance(), theXMLTypePackage.getDouble(),
				"phase2WaitingVariance", null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase3ProcWaiting(), theXMLTypePackage.getDouble(), "phase3ProcWaiting",
				null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase3ServiceTime(), theXMLTypePackage.getDouble(), "phase3ServiceTime",
				null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase3ServiceTimeVariance(), theXMLTypePackage.getDouble(),
				"phase3ServiceTimeVariance", null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase3Utilization(), theXMLTypePackage.getDouble(), "phase3Utilization",
				null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase3Waiting(), theXMLTypePackage.getDouble(), "phase3Waiting", null, 0, 1,
				ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Phase3WaitingVariance(), theXMLTypePackage.getDouble(),
				"phase3WaitingVariance", null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_ProbExceedMaxServiceTime(), theXMLTypePackage.getDouble(),
				"probExceedMaxServiceTime", null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_ProcUtilization(), theXMLTypePackage.getDouble(), "procUtilization", null,
				0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_ProcWaiting(), theXMLTypePackage.getDouble(), "procWaiting", null, 0, 1,
				ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_RwlockReaderHolding(), theXMLTypePackage.getDouble(), "rwlockReaderHolding",
				null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_RwlockReaderUtilization(), theXMLTypePackage.getDouble(),
				"rwlockReaderUtilization", null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_RwlockReaderWaiting(), theXMLTypePackage.getDouble(), "rwlockReaderWaiting",
				null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_RwlockReaderWaitingVariance(), theXMLTypePackage.getDouble(),
				"rwlockReaderWaitingVariance", null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_RwlockWriterHolding(), theXMLTypePackage.getDouble(), "rwlockWriterHolding",
				null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_RwlockWriterUtilization(), theXMLTypePackage.getDouble(),
				"rwlockWriterUtilization", null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_RwlockWriterWaiting(), theXMLTypePackage.getDouble(), "rwlockWriterWaiting",
				null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_RwlockWriterWaitingVariance(), theXMLTypePackage.getDouble(),
				"rwlockWriterWaitingVariance", null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_SemaphoreUtilization(), theXMLTypePackage.getDouble(),
				"semaphoreUtilization", null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_SemaphoreWaiting(), theXMLTypePackage.getDouble(), "semaphoreWaiting", null,
				0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_SemaphoreWaitingVariance(), theXMLTypePackage.getDouble(),
				"semaphoreWaitingVariance", null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_ServiceTime(), theXMLTypePackage.getDouble(), "serviceTime", null, 0, 1,
				ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_ServiceTimeVariance(), theXMLTypePackage.getDouble(), "serviceTimeVariance",
				null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_SquaredCoeffVariation(), theXMLTypePackage.getDouble(),
				"squaredCoeffVariation", null, 0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Throughput(), theXMLTypePackage.getDouble(), "throughput", null, 0, 1,
				ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_ThroughputBound(), theXMLTypePackage.getDouble(), "throughputBound", null,
				0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Utilization(), theXMLTypePackage.getDouble(), "utilization", null, 0, 1,
				ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_Waiting(), theXMLTypePackage.getDouble(), "waiting", null, 0, 1,
				ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf95Type1_WaitingVariance(), theXMLTypePackage.getDouble(), "waitingVariance", null,
				0, 1, ResultConf95Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(resultConf99TypeEClass, ResultConf99Type.class, "ResultConf99Type", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getResultConf99Type_JoinVariance(), theXMLTypePackage.getDouble(), "joinVariance", null, 0, 1,
				ResultConf99Type.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type_JoinWaiting(), theXMLTypePackage.getDouble(), "joinWaiting", null, 0, 1,
				ResultConf99Type.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(resultConf99Type1EClass, ResultConf99Type1.class, "ResultConf99Type1", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getResultConf99Type1_LossProbability(), theXMLTypePackage.getDouble(), "lossProbability", null,
				0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_OpenWaitTime(), theXMLTypePackage.getDouble(), "openWaitTime", null, 0, 1,
				ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase1ProcWaiting(), theXMLTypePackage.getDouble(), "phase1ProcWaiting",
				null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase1ServiceTime(), theXMLTypePackage.getDouble(), "phase1ServiceTime",
				null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase1ServiceTimeVariance(), theXMLTypePackage.getDouble(),
				"phase1ServiceTimeVariance", null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase1Utilization(), theXMLTypePackage.getDouble(), "phase1Utilization",
				null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase1Waiting(), theXMLTypePackage.getDouble(), "phase1Waiting", null, 0, 1,
				ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase1WaitingVariance(), theXMLTypePackage.getDouble(),
				"phase1WaitingVariance", null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase2ProcWaiting(), theXMLTypePackage.getDouble(), "phase2ProcWaiting",
				null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase2ServiceTime(), theXMLTypePackage.getDouble(), "phase2ServiceTime",
				null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase2ServiceTimeVariance(), theXMLTypePackage.getDouble(),
				"phase2ServiceTimeVariance", null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase2Utilization(), theXMLTypePackage.getDouble(), "phase2Utilization",
				null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase2Waiting(), theXMLTypePackage.getDouble(), "phase2Waiting", null, 0, 1,
				ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase2WaitingVariance(), theXMLTypePackage.getDouble(),
				"phase2WaitingVariance", null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase3ProcWaiting(), theXMLTypePackage.getDouble(), "phase3ProcWaiting",
				null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase3ServiceTime(), theXMLTypePackage.getDouble(), "phase3ServiceTime",
				null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase3ServiceTimeVariance(), theXMLTypePackage.getDouble(),
				"phase3ServiceTimeVariance", null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase3Utilization(), theXMLTypePackage.getDouble(), "phase3Utilization",
				null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase3Waiting(), theXMLTypePackage.getDouble(), "phase3Waiting", null, 0, 1,
				ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Phase3WaitingVariance(), theXMLTypePackage.getDouble(),
				"phase3WaitingVariance", null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_ProbExceedMaxServiceTime(), theXMLTypePackage.getDouble(),
				"probExceedMaxServiceTime", null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_ProcUtilization(), theXMLTypePackage.getDouble(), "procUtilization", null,
				0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_ProcWaiting(), theXMLTypePackage.getDouble(), "procWaiting", null, 0, 1,
				ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_RwlockReaderHolding(), theXMLTypePackage.getDouble(), "rwlockReaderHolding",
				null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_RwlockReaderUtilization(), theXMLTypePackage.getDouble(),
				"rwlockReaderUtilization", null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_RwlockReaderWaiting(), theXMLTypePackage.getDouble(), "rwlockReaderWaiting",
				null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_RwlockReaderWaitingVariance(), theXMLTypePackage.getDouble(),
				"rwlockReaderWaitingVariance", null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_RwlockWriterHolding(), theXMLTypePackage.getDouble(), "rwlockWriterHolding",
				null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_RwlockWriterUtilization(), theXMLTypePackage.getDouble(),
				"rwlockWriterUtilization", null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_RwlockWriterWaiting(), theXMLTypePackage.getDouble(), "rwlockWriterWaiting",
				null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_RwlockWriterWaitingVariance(), theXMLTypePackage.getDouble(),
				"rwlockWriterWaitingVariance", null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_SemaphoreUtilization(), theXMLTypePackage.getDouble(),
				"semaphoreUtilization", null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_SemaphoreWaiting(), theXMLTypePackage.getDouble(), "semaphoreWaiting", null,
				0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_SemaphoreWaitingVariance(), theXMLTypePackage.getDouble(),
				"semaphoreWaitingVariance", null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_ServiceTime(), theXMLTypePackage.getDouble(), "serviceTime", null, 0, 1,
				ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_ServiceTimeVariance(), theXMLTypePackage.getDouble(), "serviceTimeVariance",
				null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_SquaredCoeffVariation(), theXMLTypePackage.getDouble(),
				"squaredCoeffVariation", null, 0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Throughput(), theXMLTypePackage.getDouble(), "throughput", null, 0, 1,
				ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_ThroughputBound(), theXMLTypePackage.getDouble(), "throughputBound", null,
				0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Utilization(), theXMLTypePackage.getDouble(), "utilization", null, 0, 1,
				ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_Waiting(), theXMLTypePackage.getDouble(), "waiting", null, 0, 1,
				ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultConf99Type1_WaitingVariance(), theXMLTypePackage.getDouble(), "waitingVariance", null,
				0, 1, ResultConf99Type1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(resultGeneralTypeEClass, ResultGeneralType.class, "ResultGeneralType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getResultGeneralType_MvaInfo(), this.getMvaInfoType(), null, "mvaInfo", null, 0, 1,
				ResultGeneralType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultGeneralType_ConvVal(), theXMLTypePackage.getDouble(), "convVal", null, 1, 1,
				ResultGeneralType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultGeneralType_ElapsedTime(), theXMLTypePackage.getTime(), "elapsedTime", null, 0, 1,
				ResultGeneralType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultGeneralType_Iterations(), theXMLTypePackage.getDouble(), "iterations", null, 0, 1,
				ResultGeneralType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultGeneralType_PlatformInfo(), theXMLTypePackage.getString(), "platformInfo", null, 0, 1,
				ResultGeneralType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultGeneralType_SolverInfo(), theXMLTypePackage.getString(), "solverInfo", null, 0, 1,
				ResultGeneralType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultGeneralType_SystemCpuTime(), theXMLTypePackage.getTime(), "systemCpuTime", null, 0, 1,
				ResultGeneralType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultGeneralType_UserCpuTime(), theXMLTypePackage.getTime(), "userCpuTime", null, 0, 1,
				ResultGeneralType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getResultGeneralType_Valid(), this.getValidType(), "valid", null, 1, 1, ResultGeneralType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(runControlTypeEClass, RunControlType.class, "RunControlType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRunControlType_Para(), this.getParaType(), null, "para", null, 0, -1, RunControlType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(serviceTypeEClass, ServiceType.class, "ServiceType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getServiceType_Name(), theXMLTypePackage.getString(), "name", null, 1, 1, ServiceType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(singleActivityListTypeEClass, SingleActivityListType.class, "SingleActivityListType", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSingleActivityListType_Activity(), this.getActivityType(), null, "activity", null, 1, 1,
				SingleActivityListType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(slotTypeEClass, SlotType.class, "SlotType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSlotType_Interface(), this.getInterfaceType(), null, "interface", null, 1, 1, SlotType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSlotType_Binding(), this.getBindType(), null, "binding", null, 1, -1, SlotType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSlotType_BindTarget(), theXMLTypePackage.getString(), "bindTarget", null, 1, 1,
				SlotType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getSlotType_Id(), theXMLTypePackage.getString(), "id", null, 1, 1, SlotType.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSlotType_ReplicNum(), theXMLTypePackage.getInt(), "replicNum", null, 0, 1, SlotType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(solverParamsTypeEClass, SolverParamsType.class, "SolverParamsType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSolverParamsType_ResultGeneral(), this.getResultGeneralType(), null, "resultGeneral", null, 0,
				1, SolverParamsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSolverParamsType_Pragma(), this.getPragmaType(), null, "pragma", null, 0, -1,
				SolverParamsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSolverParamsType_Comment(), theXMLTypePackage.getString(), "comment", "", 0, 1,
				SolverParamsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getSolverParamsType_ConvVal(), theXMLTypePackage.getDouble(), "convVal", "1", 0, 1,
				SolverParamsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getSolverParamsType_ItLimit(), theXMLTypePackage.getInt(), "itLimit", "50", 0, 1,
				SolverParamsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getSolverParamsType_PrintInt(), theXMLTypePackage.getInt(), "printInt", "0", 0, 1,
				SolverParamsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getSolverParamsType_UnderrelaxCoeff(), theXMLTypePackage.getDouble(), "underrelaxCoeff", "0.9",
				0, 1, SolverParamsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(synchCallTypeEClass, SynchCallType.class, "SynchCallType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSynchCallType_Dest(), theXMLTypePackage.getString(), "dest", null, 1, 1, SynchCallType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(taskActivityGraphEClass, TaskActivityGraph.class, "TaskActivityGraph", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTaskActivityGraph_ReplyEntry(), this.getReplyEntryType(), null, "replyEntry", null, 0, -1,
		...
		initEClass(taskTypeEClass, TaskType.class, "TaskType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTaskType_ResultTask(), this.getOutputResultType(), null, "resultTask", null, 0, -1,
				TaskType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTaskType_ServiceTimeDistribution(), this.getOutputDistributionType(), null,
				"serviceTimeDistribution", null, 0, -1, TaskType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTaskType_FanOut(), this.getFanOutType(), null, "fanOut", null, 0, -1, TaskType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTaskType_FanIn(), this.getFanInType(), null, "fanIn", null, 0, -1, TaskType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTaskType_Entry(), this.getEntryType(), null, "entry", null, 1, -1, TaskType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTaskType_Service(), this.getServiceType(), null, "service", null, 0, -1, TaskType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTaskType_TaskActivities(), this.getTaskActivityGraph(), null, "taskActivities", null, 0, 1,
				TaskType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTaskType_ActivityGraph(), this.getTaskOptionType(), "activityGraph", null, 0, 1,
				TaskType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTaskType_Initially(), theXMLTypePackage.getNonNegativeInteger(), "initially", null, 0, 1,
				TaskType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTaskType_Multiplicity(), this.getSrvnNonNegativeInteger(), "multiplicity", "1", 0, 1,
				TaskType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTaskType_Name(), theXMLTypePackage.getString(), "name", null, 1, 1, TaskType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTaskType_Priority(), theXMLTypePackage.getNonNegativeInteger(), "priority", "0", 0, 1,
				TaskType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTaskType_QueueLength(), theXMLTypePackage.getNonNegativeInteger(), "queueLength", "0", 0, 1,
				TaskType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTaskType_Replication(), theXMLTypePackage.getNonNegativeInteger(), "replication", "1", 0, 1,
				TaskType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTaskType_Scheduling(), this.getTaskSchedulingType(), "scheduling", "fcfs", 0, 1,
				TaskType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTaskType_ThinkTime(), this.getSrvnFloat(), "thinkTime", "0", 0, 1, TaskType.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEDataType(callOrderTypeObjectEDataType, CallOrderType.class, "CallOrderTypeObject", IS_SERIALIZABLE,
				IS_GENERATED_INSTANCE_CLASS);
		initEDataType(connectFromTypeEDataType, List.class, "ConnectFromType", IS_SERIALIZABLE,
				!IS_GENERATED_INSTANCE_CLASS);
		initEDataType(connectToTypeEDataType, List.class, "ConnectToType", IS_SERIALIZABLE,
				!IS_GENERATED_INSTANCE_CLASS);
		...
		initEDataType(rwLockTypeObjectEDataType, RWLockType.class, "RWLockTypeObject", IS_SERIALIZABLE,
				IS_GENERATED_INSTANCE_CLASS);
		initEDataType(schedulingTypeObjectEDataType, SchedulingType.class, "SchedulingTypeObject", IS_SERIALIZABLE,
				IS_GENERATED_INSTANCE_CLASS);
		initEDataType(semaphoreTypeObjectEDataType, SemaphoreType.class, "SemaphoreTypeObject", IS_SERIALIZABLE,
				IS_GENERATED_INSTANCE_CLASS);
		initEDataType(srvnFloatEDataType, Object.class, "SrvnFloat", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
		initEDataType(srvnNonNegativeIntegerEDataType, Object.class, "SrvnNonNegativeInteger", IS_SERIALIZABLE,
				!IS_GENERATED_INSTANCE_CLASS);
		initEDataType(taskOptionTypeObjectEDataType, TaskOptionType.class, "TaskOptionTypeObject", IS_SERIALIZABLE,
				IS_GENERATED_INSTANCE_CLASS);
		initEDataType(taskSchedulingTypeObjectEDataType, TaskSchedulingType.class, "TaskSchedulingTypeObject",
				IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
		initEDataType(typeTypeObjectEDataType, TypeType.class, "TypeTypeObject", IS_SERIALIZABLE,
				IS_GENERATED_INSTANCE_CLASS);
		initEDataType(validTypeObjectEDataType, ValidType.class, "ValidTypeObject", IS_SERIALIZABLE,
				IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation(activityDefBaseEClass, source, new String[] { "name", "ActivityDefBase", "kind", "elementOnly" });
		addAnnotation(getActivityDefBase_ServiceTimeDistribution(), source, new String[] { "kind", "element", "name",
				"service-time-distribution", "namespace", "##targetNamespace" });
		...
		addAnnotation(getActivityDefBase_CallOrder(), source,
		...
		addAnnotation(getActivityDefBase_Name(), source,
				new String[] { "kind", "attribute", "name", "name", "namespace", "##targetNamespace" });
		addAnnotation(getActivityDefBase_ThinkTime(), source,
				new String[] { "kind", "attribute", "name", "think-time", "namespace", "##targetNamespace" });
		addAnnotation(activityDefTypeEClass, source, new String[] { "name", "ActivityDefType", "kind", "elementOnly" });
		addAnnotation(getActivityDefType_CallList(), source,
				new String[] { "kind", "element", "name", "call-list", "namespace", "##targetNamespace" });
		addAnnotation(getActivityDefType_Group(), source, new String[] { "kind", "group", "name", "group:9" });
		addAnnotation(getActivityDefType_SynchCall(), source, new String[] { "kind", "element", "name", "synch-call",
				"namespace", "##targetNamespace", "group", "group:9" });
		addAnnotation(getActivityDefType_AsynchCall(), source, new String[] { "kind", "element", "name", "asynch-call",
				"namespace", "##targetNamespace", "group", "group:9" });
		addAnnotation(getActivityDefType_BoundToEntry(), source,
				new String[] { "kind", "attribute", "name", "bound-to-entry", "namespace", "##targetNamespace" });
		addAnnotation(activityGraphBaseEClass, source,
				new String[] { "name", "ActivityGraphBase", "kind", "elementOnly" });
		addAnnotation(getActivityGraphBase_Activity(), source,
				new String[] { "kind", "element", "name", "activity", "namespace", "##targetNamespace" });
		addAnnotation(getActivityGraphBase_Precedence(), source,
				new String[] { "kind", "element", "name", "precedence", "namespace", "##targetNamespace" });
		addAnnotation(activityListTypeEClass, source,
				new String[] { "name", "ActivityListType", "kind", "elementOnly" });
		addAnnotation(getActivityListType_Activity(), source,
				new String[] { "kind", "element", "name", "activity", "namespace", "##targetNamespace" });
		addAnnotation(activityLoopListTypeEClass, source,
				new String[] { "name", "ActivityLoopListType", "kind", "elementOnly" });
		addAnnotation(getActivityLoopListType_Activity(), source,
				new String[] { "kind", "element", "name", "activity", "namespace", "##targetNamespace" });
		addAnnotation(getActivityLoopListType_End(), source,
				new String[] { "kind", "attribute", "name", "end", "namespace", "##targetNamespace" });
		addAnnotation(activityLoopTypeEClass, source, new String[] { "name", "ActivityLoopType", "kind", "empty" });
		addAnnotation(getActivityLoopType_Count(), source,
				new String[] { "kind", "attribute", "name", "count", "namespace", "##targetNamespace" });
		addAnnotation(activityMakingCallTypeEClass, source,
		...
		addAnnotation(activityOrTypeEClass, source, new String[] { "name", "ActivityOrType", "kind", "empty" });
		addAnnotation(getActivityOrType_Prob(), source,
				new String[] { "kind", "attribute", "name", "prob", "namespace", "##targetNamespace" });
		addAnnotation(activityPhasesTypeEClass, source,
				new String[] { "name", "ActivityPhasesType", "kind", "elementOnly" });
		addAnnotation(getActivityPhasesType_CallList(), source,
				new String[] { "kind", "element", "name", "call-list", "namespace", "##targetNamespace" });
		addAnnotation(getActivityPhasesType_Group(), source, new String[] { "kind", "group", "name", "group:9" });
		addAnnotation(getActivityPhasesType_SynchCall(), source, new String[] { "kind", "element", "name", "synch-call",
				"namespace", "##targetNamespace", "group", "group:9" });
		addAnnotation(getActivityPhasesType_AsynchCall(), source, new String[] { "kind", "element", "name",
				"asynch-call", "namespace", "##targetNamespace", "group", "group:9" });
		addAnnotation(getActivityPhasesType_Phase(), source,
				new String[] { "kind", "attribute", "name", "phase", "namespace", "##targetNamespace" });
		addAnnotation(activityTypeEClass, source, new String[] { "name", "ActivityType", "kind", "empty" });
		addAnnotation(getActivityType_Name(), source,
				new String[] { "kind", "attribute", "name", "name", "namespace", "##targetNamespace" });
		addAnnotation(andJoinListTypeEClass, source, new String[] { "name", "AndJoinListType", "kind", "elementOnly" });
		...
		addAnnotation(getAndJoinListType_ServiceTimeDistribution(), source, new String[] { "kind", "element", "name",
				"service-time-distribution", "namespace", "##targetNamespace" });
		addAnnotation(getAndJoinListType_Activity(), source,
				new String[] { "kind", "element", "name", "activity", "namespace", "##targetNamespace" });
		addAnnotation(getAndJoinListType_Quorum(), source,
				new String[] { "kind", "attribute", "name", "quorum", "namespace", "##targetNamespace" });
		addAnnotation(asynchCallTypeEClass, source, new String[] { "name", "asynch-call_._type", "kind", "empty" });
		addAnnotation(getAsynchCallType_Dest(), source,
				new String[] { "kind", "attribute", "name", "dest", "namespace", "##targetNamespace" });
		addAnnotation(bindTypeEClass, source, new String[] { "name", "BindType", "kind", "elementOnly" });
		addAnnotation(getBindType_Parameter(), source,
				new String[] { "kind", "element", "name", "parameter", "namespace", "##targetNamespace" });
		addAnnotation(getBindType_ProcessorBinding(), source,
				new String[] { "kind", "element", "name", "processor-binding", "namespace", "##targetNamespace" });
		addAnnotation(getBindType_PortBinding(), source,
				new String[] { "kind", "element", "name", "port-binding", "namespace", "##targetNamespace" });
		addAnnotation(callListTypeEClass, source, new String[] { "name", "call-list_._type", "kind", "elementOnly" });
		addAnnotation(getCallListType_SynchCall(), source,
				new String[] { "kind", "element", "name", "synch-call", "namespace", "##targetNamespace" });
		addAnnotation(getCallListType_AsynchCall(), source,
				new String[] { "kind", "element", "name", "asynch-call", "namespace", "##targetNamespace" });
		addAnnotation(callOrderTypeEEnum, source, new String[] { "name", "CallOrderType" });
		addAnnotation(callOrderTypeObjectEDataType, source,
				new String[] { "name", "CallOrderType:Object", "baseType", "CallOrderType" });
		addAnnotation(connectFromTypeEDataType, source, new String[] { "name", "connect-from_._type", "itemType",
				"http://www.eclipse.org/emf/2003/XMLType#string" });
		addAnnotation(connectToTypeEDataType, source, new String[] { "name", "connect-to_._type", "itemType",
				"http://www.eclipse.org/emf/2003/XMLType#string" });
		...
		addAnnotation(getDocumentRoot_LqnModel(), source,
				new String[] { "kind", "element", "name", "lqn-model", "namespace", "##targetNamespace" });
		addAnnotation(entryActivityDefTypeEClass, source,
				new String[] { "name", "EntryActivityDefType", "kind", "elementOnly" });
		addAnnotation(getEntryActivityDefType_CallList(), source,
				new String[] { "kind", "element", "name", "call-list", "namespace", "##targetNamespace" });
		addAnnotation(getEntryActivityDefType_Group(), source, new String[] { "kind", "group", "name", "group:9" });
		addAnnotation(getEntryActivityDefType_SynchCall(), source, new String[] { "kind", "element", "name",
				"synch-call", "namespace", "##targetNamespace", "group", "group:9" });
		addAnnotation(getEntryActivityDefType_AsynchCall(), source, new String[] { "kind", "element", "name",
				"asynch-call", "namespace", "##targetNamespace", "group", "group:9" });
		...
		addAnnotation(entryActivityGraphEClass, source,
		...
		addAnnotation(entryMakingCallTypeEClass, source,
				new String[] { "name", "EntryMakingCallType", "kind", "elementOnly" });
		addAnnotation(getEntryMakingCallType_Prob(), source,
				new String[] { "kind", "attribute", "name", "prob", "namespace", "##targetNamespace" });
		addAnnotation(entryTypeEClass, source, new String[] { "name", "EntryType", "kind", "elementOnly" });
		addAnnotation(getEntryType_ResultEntry(), source,
				new String[] { "kind", "element", "name", "result-entry", "namespace", "##targetNamespace" });
		addAnnotation(getEntryType_ServiceTimeDistribution(), source, new String[] { "kind", "element", "name",
				"service-time-distribution", "namespace", "##targetNamespace" });
		addAnnotation(getEntryType_Forwarding(), source,
				new String[] { "kind", "element", "name", "forwarding", "namespace", "##targetNamespace" });
		addAnnotation(getEntryType_EntryActivityGraph(), source,
		...
		addAnnotation(getEntryType_Name(), source,
				new String[] { "kind", "attribute", "name", "name", "namespace", "##targetNamespace" });
		addAnnotation(getEntryType_OpenArrivalRate(), source,
				new String[] { "kind", "attribute", "name", "open-arrival-rate", "namespace", "##targetNamespace" });
		addAnnotation(getEntryType_Priority(), source,
				new String[] { "kind", "attribute", "name", "priority", "namespace", "##targetNamespace" });
		addAnnotation(getEntryType_Rwlock(), source,
				new String[] { "kind", "attribute", "name", "rwlock", "namespace", "##targetNamespace" });
		addAnnotation(getEntryType_Semaphore(), source,
				new String[] { "kind", "attribute", "name", "semaphore", "namespace", "##targetNamespace" });
		addAnnotation(getEntryType_Type(), source,
				new String[] { "kind", "attribute", "name", "type", "namespace", "##targetNamespace" });
		addAnnotation(extVariableEDataType, source, new String[] { "name", "ExtVariable", "baseType",
				"http://www.eclipse.org/emf/2003/XMLType#string", "pattern", "$(_|[a-zA-Z])(([a-zA-Z]|[0-9]|_)+)?" });
		addAnnotation(fanInTypeEClass, source, new String[] { "name", "FanInType", "kind", "empty" });
		...
		addAnnotation(fanOutTypeEClass, source, new String[] { "name", "FanOutType", "kind", "empty" });
		addAnnotation(getFanOutType_Dest(), source,
				new String[] { "kind", "attribute", "name", "dest", "namespace", "##targetNamespace" });
		addAnnotation(getFanOutType_Value(), source,
				new String[] { "kind", "attribute", "name", "value", "namespace", "##targetNamespace" });
		addAnnotation(firstPlotTypeEClass, source, new String[] { "name", "first-plot_._type", "kind", "empty" });
		addAnnotation(getFirstPlotType_Variable(), source,
				new String[] { "kind", "attribute", "name", "variable", "namespace", "##targetNamespace" });
		addAnnotation(groupTypeEClass, source, new String[] { "name", "GroupType", "kind", "elementOnly" });
		addAnnotation(getGroupType_ResultGroup(), source,
				new String[] { "kind", "element", "name", "result-group", "namespace", "##targetNamespace" });
		addAnnotation(getGroupType_Task(), source,
				new String[] { "kind", "element", "name", "task", "namespace", "##targetNamespace" });
		addAnnotation(getGroupType_Cap(), source,
				new String[] { "kind", "attribute", "name", "cap", "namespace", "##targetNamespace" });
		addAnnotation(getGroupType_Name(), source,
				new String[] { "kind", "attribute", "name", "name", "namespace", "##targetNamespace" });
		addAnnotation(getGroupType_Share(), source,
				new String[] { "kind", "attribute", "name", "share", "namespace", "##targetNamespace" });
		addAnnotation(histogramBinTypeEClass, source, new String[] { "name", "HistogramBinType", "kind", "empty" });
		addAnnotation(getHistogramBinType_Begin(), source,
				new String[] { "kind", "attribute", "name", "begin", "namespace", "##targetNamespace" });
		addAnnotation(getHistogramBinType_Conf95(), source,
				new String[] { "kind", "attribute", "name", "conf-95", "namespace", "##targetNamespace" });
		addAnnotation(getHistogramBinType_Conf99(), source,
				new String[] { "kind", "attribute", "name", "conf-99", "namespace", "##targetNamespace" });
		addAnnotation(getHistogramBinType_End(), source,
				new String[] { "kind", "attribute", "name", "end", "namespace", "##targetNamespace" });
		addAnnotation(getHistogramBinType_Prob(), source,
				new String[] { "kind", "attribute", "name", "prob", "namespace", "##targetNamespace" });
		addAnnotation(inPortTypeEClass, source, new String[] { "name", "in-port_._type", "kind", "empty" });
		addAnnotation(getInPortType_ConnectFrom(), source,
				new String[] { "kind", "attribute", "name", "connect-from", "namespace", "##targetNamespace" });
		addAnnotation(getInPortType_Description(), source,
				new String[] { "kind", "attribute", "name", "description", "namespace", "##targetNamespace" });
		addAnnotation(getInPortType_Name(), source,
				new String[] { "kind", "attribute", "name", "name", "namespace", "##targetNamespace" });
		addAnnotation(interfaceTypeEClass, source, new String[] { "name", "Interface_._type", "kind", "elementOnly" });
		addAnnotation(getInterfaceType_InPort(), source,
				new String[] { "kind", "element", "name", "in-port", "namespace", "##targetNamespace" });
		addAnnotation(getInterfaceType_OutPort(), source,
				new String[] { "kind", "element", "name", "out-port", "namespace", "##targetNamespace" });
		addAnnotation(lqnCoreTypeEClass, source, new String[] { "name", "Lqn-CoreType", "kind", "elementOnly" });
		addAnnotation(getLqnCoreType_Processor(), source,
				new String[] { "kind", "element", "name", "processor", "namespace", "##targetNamespace" });
		addAnnotation(getLqnCoreType_Slot(), source,
				new String[] { "kind", "element", "name", "slot", "namespace", "##targetNamespace" });
		addAnnotation(lqnModelTypeEClass, source, new String[] { "name", "LqnModelType", "kind", "elementOnly" });
		addAnnotation(getLqnModelType_RunControl(), source,
				new String[] { "kind", "element", "name", "run-control", "namespace", "##targetNamespace" });
		addAnnotation(getLqnModelType_PlotControl(), source,
				new String[] { "kind", "element", "name", "plot-control", "namespace", "##targetNamespace" });
		addAnnotation(getLqnModelType_SolverParams(), source,
				new String[] { "kind", "element", "name", "solver-params", "namespace", "##targetNamespace" });
		addAnnotation(getLqnModelType_Processor(), source,
				new String[] { "kind", "element", "name", "processor", "namespace", "##targetNamespace" });
		addAnnotation(getLqnModelType_Slot(), source,
				new String[] { "kind", "element", "name", "slot", "namespace", "##targetNamespace" });
		addAnnotation(getLqnModelType_Lqx(), source,
				new String[] { "kind", "element", "name", "lqx", "namespace", "##targetNamespace" });
		addAnnotation(getLqnModelType_Description(), source,
				new String[] { "kind", "attribute", "name", "description", "namespace", "##targetNamespace" });
		addAnnotation(getLqnModelType_LqnSchemaVersion(), source,
				new String[] { "kind", "attribute", "name", "lqn-schema-version", "namespace", "##targetNamespace" });
		addAnnotation(getLqnModelType_LqncoreSchemaVersion(), source, new String[] { "kind", "attribute", "name",
				"lqncore-schema-version", "namespace", "##targetNamespace" });
		addAnnotation(getLqnModelType_Name(), source,
				new String[] { "kind", "attribute", "name", "name", "namespace", "##targetNamespace" });
		addAnnotation(getLqnModelType_XmlDebug(), source,
				new String[] { "kind", "attribute", "name", "xml-debug", "namespace", "##targetNamespace" });
		addAnnotation(makingCallTypeEClass, source, new String[] { "name", "MakingCallType", "kind", "elementOnly" });
		addAnnotation(getMakingCallType_ResultCall(), source,
				new String[] { "kind", "element", "name", "result-call", "namespace", "##targetNamespace" });
		addAnnotation(getMakingCallType_Dest(), source,
				new String[] { "kind", "attribute", "name", "dest", "namespace", "##targetNamespace" });
		addAnnotation(mvaInfoTypeEClass, source, new String[] { "name", "mva-info_._type", "kind", "empty" });
		addAnnotation(getMvaInfoType_Core(), source,
				new String[] { "kind", "attribute", "name", "core", "namespace", "##targetNamespace" });
		addAnnotation(getMvaInfoType_Faults(), source,
				new String[] { "kind", "attribute", "name", "faults", "namespace", "##targetNamespace" });
		addAnnotation(getMvaInfoType_Step(), source,
				new String[] { "kind", "attribute", "name", "step", "namespace", "##targetNamespace" });
		addAnnotation(getMvaInfoType_StepSquared(), source,
				new String[] { "kind", "attribute", "name", "step-squared", "namespace", "##targetNamespace" });
		addAnnotation(getMvaInfoType_Submodels(), source,
				new String[] { "kind", "attribute", "name", "submodels", "namespace", "##targetNamespace" });
		addAnnotation(getMvaInfoType_Wait(), source,
				new String[] { "kind", "attribute", "name", "wait", "namespace", "##targetNamespace" });
		addAnnotation(getMvaInfoType_WaitSquared(), source,
				new String[] { "kind", "attribute", "name", "wait-squared", "namespace", "##targetNamespace" });
		addAnnotation(orListTypeEClass, source, new String[] { "name", "OrListType", "kind", "elementOnly" });
		addAnnotation(getOrListType_Activity(), source,
				new String[] { "kind", "element", "name", "activity", "namespace", "##targetNamespace" });
		addAnnotation(outPortTypeEClass, source, new String[] { "name", "out-port_._type", "kind", "empty" });
		addAnnotation(getOutPortType_ConnectTo(), source,
				new String[] { "kind", "attribute", "name", "connect-to", "namespace", "##targetNamespace" });
		addAnnotation(getOutPortType_Description(), source,
				new String[] { "kind", "attribute", "name", "description", "namespace", "##targetNamespace" });
		addAnnotation(getOutPortType_Name(), source,
				new String[] { "kind", "attribute", "name", "name", "namespace", "##targetNamespace" });
		addAnnotation(outputDistributionTypeEClass, source,
		...
		addAnnotation(getOutputDistributionType_Max(), source,
				new String[] { "kind", "attribute", "name", "max", "namespace", "##targetNamespace" });
		addAnnotation(getOutputDistributionType_Mean(), source,
		...
		addAnnotation(getOutputDistributionType_Min(), source,
		...
		addAnnotation(getOutputDistributionType_Skew(), source,
				new String[] { "kind", "attribute", "name", "skew", "namespace", "##targetNamespace" });
		addAnnotation(getOutputDistributionType_StdDev(), source,
				new String[] { "kind", "attribute", "name", "std-dev", "namespace", "##targetNamespace" });
		addAnnotation(outputEntryDistributionTypeEClass, source,
				new String[] { "name", "OutputEntryDistributionType", "kind", "elementOnly" });
		addAnnotation(getOutputEntryDistributionType_Phase(), source,
				new String[] { "kind", "attribute", "name", "phase", "namespace", "##targetNamespace" });
		addAnnotation(outputResultJoinDelayTypeEClass, source,
				new String[] { "name", "OutputResultJoinDelayType", "kind", "elementOnly" });
		...
		addAnnotation(outputResultTypeEClass, source,
				new String[] { "name", "OutputResultType", "kind", "elementOnly" });
		addAnnotation(getOutputResultType_ResultConf95(), source,
				new String[] { "kind", "element", "name", "result-conf-95", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_ResultConf99(), source,
				new String[] { "kind", "element", "name", "result-conf-99", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_LossProbability(), source,
				new String[] { "kind", "attribute", "name", "loss-probability", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_OpenWaitTime(), source,
				new String[] { "kind", "attribute", "name", "open-wait-time", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_Phase1ProcWaiting(), source,
				new String[] { "kind", "attribute", "name", "phase1-proc-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_Phase1ServiceTime(), source,
				new String[] { "kind", "attribute", "name", "phase1-service-time", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_Phase1ServiceTimeVariance(), source, new String[] { "kind", "attribute",
				"name", "phase1-service-time-variance", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_Phase1Utilization(), source,
		...
		addAnnotation(getOutputResultType_Phase1Waiting(), source,
				new String[] { "kind", "attribute", "name", "phase1-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_Phase1WaitingVariance(), source, new String[] { "kind", "attribute", "name",
				"phase1-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_Phase2ProcWaiting(), source,
				new String[] { "kind", "attribute", "name", "phase2-proc-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_Phase2ServiceTime(), source,
				new String[] { "kind", "attribute", "name", "phase2-service-time", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_Phase2ServiceTimeVariance(), source, new String[] { "kind", "attribute",
				"name", "phase2-service-time-variance", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_Phase2Utilization(), source,
		...
		addAnnotation(getOutputResultType_Phase2Waiting(), source,
				new String[] { "kind", "attribute", "name", "phase2-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_Phase2WaitingVariance(), source, new String[] { "kind", "attribute", "name",
				"phase2-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_Phase3ProcWaiting(), source,
				new String[] { "kind", "attribute", "name", "phase3-proc-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_Phase3ServiceTime(), source,
				new String[] { "kind", "attribute", "name", "phase3-service-time", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_Phase3ServiceTimeVariance(), source, new String[] { "kind", "attribute",
				"name", "phase3-service-time-variance", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_Phase3Utilization(), source,
		...
		addAnnotation(getOutputResultType_Phase3Waiting(), source,
				new String[] { "kind", "attribute", "name", "phase3-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_Phase3WaitingVariance(), source, new String[] { "kind", "attribute", "name",
				"phase3-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_ProbExceedMaxServiceTime(), source, new String[] { "kind", "attribute",
				"name", "prob-exceed-max-service-time", "namespace", "##targetNamespace" });
		...
		addAnnotation(getOutputResultType_ProcWaiting(), source,
				new String[] { "kind", "attribute", "name", "proc-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_RwlockReaderHolding(), source, new String[] { "kind", "attribute", "name",
				"rwlock-reader-holding", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_RwlockReaderUtilization(), source, new String[] { "kind", "attribute", "name",
				"rwlock-reader-utilization", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_RwlockReaderWaiting(), source, new String[] { "kind", "attribute", "name",
				"rwlock-reader-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_RwlockReaderWaitingVariance(), source, new String[] { "kind", "attribute",
				"name", "rwlock-reader-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_RwlockWriterHolding(), source, new String[] { "kind", "attribute", "name",
				"rwlock-writer-holding", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_RwlockWriterUtilization(), source, new String[] { "kind", "attribute", "name",
				"rwlock-writer-utilization", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_RwlockWriterWaiting(), source, new String[] { "kind", "attribute", "name",
				"rwlock-writer-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_RwlockWriterWaitingVariance(), source, new String[] { "kind", "attribute",
				"name", "rwlock-writer-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_SemaphoreUtilization(), source, new String[] { "kind", "attribute", "name",
				"semaphore-utilization", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_SemaphoreWaiting(), source,
				new String[] { "kind", "attribute", "name", "semaphore-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_SemaphoreWaitingVariance(), source, new String[] { "kind", "attribute",
				"name", "semaphore-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_ServiceTime(), source,
				new String[] { "kind", "attribute", "name", "service-time", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_ServiceTimeVariance(), source, new String[] { "kind", "attribute", "name",
				"service-time-variance", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_SquaredCoeffVariation(), source, new String[] { "kind", "attribute", "name",
				"squared-coeff-variation", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_Throughput(), source,
		...
		addAnnotation(getOutputResultType_Utilization(), source,
				new String[] { "kind", "attribute", "name", "utilization", "namespace", "##targetNamespace" });
		addAnnotation(getOutputResultType_Waiting(), source,
		...
		addAnnotation(getParameterType_Value(), source,
				new String[] { "kind", "attribute", "name", "value", "namespace", "##targetNamespace" });
		addAnnotation(paraTypeEClass, source, new String[] { "name", "para_._type", "kind", "elementOnly" });
		addAnnotation(getParaType_StartValue(), source,
				new String[] { "kind", "element", "name", "start-value", "namespace", "##targetNamespace" });
		addAnnotation(getParaType_EndValue(), source,
				new String[] { "kind", "element", "name", "end-value", "namespace", "##targetNamespace" });
		addAnnotation(getParaType_StepValue(), source,
				new String[] { "kind", "element", "name", "step-value", "namespace", "##targetNamespace" });
		addAnnotation(getParaType_Value(), source,
				new String[] { "kind", "element", "name", "value", "namespace", "##targetNamespace" });
		addAnnotation(phaseActivitiesEClass, source, new String[] { "name", "PhaseActivities", "kind", "elementOnly" });
		addAnnotation(getPhaseActivities_Activity(), source,
				new String[] { "kind", "element", "name", "activity", "namespace", "##targetNamespace" });
		addAnnotation(phaseTypeEDataType, source,
				new String[] { "name", "phase_._type", "baseType",
						"http://www.eclipse.org/emf/2003/XMLType#positiveInteger", "minInclusive", "1", "maxInclusive",
						"3" });
		addAnnotation(plotControlTypeEClass, source,
				new String[] { "name", "plot-control_._type", "kind", "elementOnly" });
		addAnnotation(getPlotControlType_FirstPlot(), source,
				new String[] { "kind", "element", "name", "first-plot", "namespace", "##targetNamespace" });
		addAnnotation(getPlotControlType_Plot(), source,
				new String[] { "kind", "element", "name", "plot", "namespace", "##targetNamespace" });
		addAnnotation(plotTypeEClass, source, new String[] { "name", "plot_._type", "kind", "empty" });
		addAnnotation(getPlotType_Variable(), source,
				new String[] { "kind", "attribute", "name", "variable", "namespace", "##targetNamespace" });
		addAnnotation(portBindingTypeEClass, source, new String[] { "name", "port-binding_._type", "kind", "empty" });
		addAnnotation(getPortBindingType_Source(), source,
				new String[] { "kind", "attribute", "name", "source", "namespace", "##targetNamespace" });
		addAnnotation(getPortBindingType_Target(), source,
				new String[] { "kind", "attribute", "name", "target", "namespace", "##targetNamespace" });
		addAnnotation(pragmaTypeEClass, source, new String[] { "name", "pragma_._type", "kind", "empty" });
		...
		addAnnotation(getPragmaType_Value(), source,
				new String[] { "kind", "attribute", "name", "value", "namespace", "##targetNamespace" });
		addAnnotation(precedenceTypeEClass, source, new String[] { "name", "PrecedenceType", "kind", "elementOnly" });
		addAnnotation(getPrecedenceType_Pre(), source,
				new String[] { "kind", "element", "name", "pre", "namespace", "##targetNamespace" });
		addAnnotation(getPrecedenceType_PreOR(), source,
				new String[] { "kind", "element", "name", "pre-OR", "namespace", "##targetNamespace" });
		addAnnotation(getPrecedenceType_PreAND(), source,
				new String[] { "kind", "element", "name", "pre-AND", "namespace", "##targetNamespace" });
		addAnnotation(getPrecedenceType_Post(), source,
				new String[] { "kind", "element", "name", "post", "namespace", "##targetNamespace" });
		addAnnotation(getPrecedenceType_PostOR(), source,
				new String[] { "kind", "element", "name", "post-OR", "namespace", "##targetNamespace" });
		addAnnotation(getPrecedenceType_PostAND(), source,
				new String[] { "kind", "element", "name", "post-AND", "namespace", "##targetNamespace" });
		addAnnotation(getPrecedenceType_PostLOOP(), source,
				new String[] { "kind", "element", "name", "post-LOOP", "namespace", "##targetNamespace" });
		addAnnotation(processorBindingTypeEClass, source,
				new String[] { "name", "processor-binding_._type", "kind", "empty" });
		addAnnotation(getProcessorBindingType_Source(), source,
				new String[] { "kind", "attribute", "name", "source", "namespace", "##targetNamespace" });
		addAnnotation(getProcessorBindingType_Target(), source,
				new String[] { "kind", "attribute", "name", "target", "namespace", "##targetNamespace" });
		addAnnotation(processorTypeEClass, source, new String[] { "name", "ProcessorType", "kind", "elementOnly" });
		addAnnotation(getProcessorType_ResultProcessor(), source,
				new String[] { "kind", "element", "name", "result-processor", "namespace", "##targetNamespace" });
		addAnnotation(getProcessorType_Group(), source,
				new String[] { "kind", "element", "name", "group", "namespace", "##targetNamespace" });
		addAnnotation(getProcessorType_Task(), source,
				new String[] { "kind", "element", "name", "task", "namespace", "##targetNamespace" });
		addAnnotation(getProcessorType_Multiplicity(), source,
				new String[] { "kind", "attribute", "name", "multiplicity", "namespace", "##targetNamespace" });
		addAnnotation(getProcessorType_Name(), source,
				new String[] { "kind", "attribute", "name", "name", "namespace", "##targetNamespace" });
		addAnnotation(getProcessorType_Quantum(), source,
				new String[] { "kind", "attribute", "name", "quantum", "namespace", "##targetNamespace" });
		addAnnotation(getProcessorType_Replication(), source,
				new String[] { "kind", "attribute", "name", "replication", "namespace", "##targetNamespace" });
		addAnnotation(getProcessorType_Scheduling(), source,
				new String[] { "kind", "attribute", "name", "scheduling", "namespace", "##targetNamespace" });
		addAnnotation(getProcessorType_SpeedFactor(), source,
				new String[] { "kind", "attribute", "name", "speed-factor", "namespace", "##targetNamespace" });
		addAnnotation(replyActivityTypeEClass, source,
				new String[] { "name", "reply-activity_._type", "kind", "empty" });
		addAnnotation(getReplyActivityType_Name(), source,
				new String[] { "kind", "attribute", "name", "name", "namespace", "##targetNamespace" });
		addAnnotation(replyEntryTypeEClass, source,
				new String[] { "name", "reply-entry_._type", "kind", "elementOnly" });
		addAnnotation(getReplyEntryType_ReplyActivity(), source,
				new String[] { "kind", "element", "name", "reply-activity", "namespace", "##targetNamespace" });
		addAnnotation(getReplyEntryType_Name(), source,
				new String[] { "kind", "attribute", "name", "name", "namespace", "##targetNamespace" });
		addAnnotation(resultConf95TypeEClass, source,
				new String[] { "name", "result-conf-95_._type", "kind", "empty" });
		addAnnotation(getResultConf95Type_JoinVariance(), source,
				new String[] { "kind", "attribute", "name", "join-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type_JoinWaiting(), source,
				new String[] { "kind", "attribute", "name", "join-waiting", "namespace", "##targetNamespace" });
		addAnnotation(resultConf95Type1EClass, source,
		...
		addAnnotation(getResultConf95Type1_OpenWaitTime(), source,
				new String[] { "kind", "attribute", "name", "open-wait-time", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase1ProcWaiting(), source,
				new String[] { "kind", "attribute", "name", "phase1-proc-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase1ServiceTime(), source,
				new String[] { "kind", "attribute", "name", "phase1-service-time", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase1ServiceTimeVariance(), source, new String[] { "kind", "attribute",
				"name", "phase1-service-time-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase1Utilization(), source,
				new String[] { "kind", "attribute", "name", "phase1-utilization", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase1Waiting(), source,
				new String[] { "kind", "attribute", "name", "phase1-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase1WaitingVariance(), source, new String[] { "kind", "attribute", "name",
				"phase1-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase2ProcWaiting(), source,
				new String[] { "kind", "attribute", "name", "phase2-proc-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase2ServiceTime(), source,
				new String[] { "kind", "attribute", "name", "phase2-service-time", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase2ServiceTimeVariance(), source, new String[] { "kind", "attribute",
				"name", "phase2-service-time-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase2Utilization(), source,
				new String[] { "kind", "attribute", "name", "phase2-utilization", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase2Waiting(), source,
				new String[] { "kind", "attribute", "name", "phase2-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase2WaitingVariance(), source, new String[] { "kind", "attribute", "name",
				"phase2-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase3ProcWaiting(), source,
				new String[] { "kind", "attribute", "name", "phase3-proc-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase3ServiceTime(), source,
				new String[] { "kind", "attribute", "name", "phase3-service-time", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase3ServiceTimeVariance(), source, new String[] { "kind", "attribute",
				"name", "phase3-service-time-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase3Utilization(), source,
				new String[] { "kind", "attribute", "name", "phase3-utilization", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase3Waiting(), source,
				new String[] { "kind", "attribute", "name", "phase3-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Phase3WaitingVariance(), source, new String[] { "kind", "attribute", "name",
				"phase3-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_ProbExceedMaxServiceTime(), source, new String[] { "kind", "attribute",
				"name", "prob-exceed-max-service-time", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_ProcUtilization(), source,
				new String[] { "kind", "attribute", "name", "proc-utilization", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_ProcWaiting(), source,
				new String[] { "kind", "attribute", "name", "proc-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_RwlockReaderHolding(), source, new String[] { "kind", "attribute", "name",
				"rwlock-reader-holding", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_RwlockReaderUtilization(), source, new String[] { "kind", "attribute",
				"name", "rwlock-reader-utilization", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_RwlockReaderWaiting(), source, new String[] { "kind", "attribute", "name",
				"rwlock-reader-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_RwlockReaderWaitingVariance(), source, new String[] { "kind", "attribute",
				"name", "rwlock-reader-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_RwlockWriterHolding(), source, new String[] { "kind", "attribute", "name",
				"rwlock-writer-holding", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_RwlockWriterUtilization(), source, new String[] { "kind", "attribute",
				"name", "rwlock-writer-utilization", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_RwlockWriterWaiting(), source, new String[] { "kind", "attribute", "name",
				"rwlock-writer-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_RwlockWriterWaitingVariance(), source, new String[] { "kind", "attribute",
				"name", "rwlock-writer-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_SemaphoreUtilization(), source, new String[] { "kind", "attribute", "name",
				"semaphore-utilization", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_SemaphoreWaiting(), source,
				new String[] { "kind", "attribute", "name", "semaphore-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_SemaphoreWaitingVariance(), source, new String[] { "kind", "attribute",
				"name", "semaphore-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_ServiceTime(), source,
				new String[] { "kind", "attribute", "name", "service-time", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_ServiceTimeVariance(), source, new String[] { "kind", "attribute", "name",
				"service-time-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_SquaredCoeffVariation(), source, new String[] { "kind", "attribute", "name",
				"squared-coeff-variation", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Throughput(), source,
				new String[] { "kind", "attribute", "name", "throughput", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_ThroughputBound(), source,
				new String[] { "kind", "attribute", "name", "throughput-bound", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Utilization(), source,
				new String[] { "kind", "attribute", "name", "utilization", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_Waiting(), source,
				new String[] { "kind", "attribute", "name", "waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf95Type1_WaitingVariance(), source,
				new String[] { "kind", "attribute", "name", "waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(resultConf99TypeEClass, source,
				new String[] { "name", "result-conf-99_._type", "kind", "empty" });
		addAnnotation(getResultConf99Type_JoinVariance(), source,
				new String[] { "kind", "attribute", "name", "join-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type_JoinWaiting(), source,
				new String[] { "kind", "attribute", "name", "join-waiting", "namespace", "##targetNamespace" });
		addAnnotation(resultConf99Type1EClass, source,
		...
		addAnnotation(getResultConf99Type1_OpenWaitTime(), source,
				new String[] { "kind", "attribute", "name", "open-wait-time", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase1ProcWaiting(), source,
				new String[] { "kind", "attribute", "name", "phase1-proc-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase1ServiceTime(), source,
				new String[] { "kind", "attribute", "name", "phase1-service-time", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase1ServiceTimeVariance(), source, new String[] { "kind", "attribute",
				"name", "phase1-service-time-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase1Utilization(), source,
				new String[] { "kind", "attribute", "name", "phase1-utilization", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase1Waiting(), source,
				new String[] { "kind", "attribute", "name", "phase1-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase1WaitingVariance(), source, new String[] { "kind", "attribute", "name",
				"phase1-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase2ProcWaiting(), source,
				new String[] { "kind", "attribute", "name", "phase2-proc-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase2ServiceTime(), source,
				new String[] { "kind", "attribute", "name", "phase2-service-time", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase2ServiceTimeVariance(), source, new String[] { "kind", "attribute",
				"name", "phase2-service-time-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase2Utilization(), source,
				new String[] { "kind", "attribute", "name", "phase2-utilization", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase2Waiting(), source,
				new String[] { "kind", "attribute", "name", "phase2-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase2WaitingVariance(), source, new String[] { "kind", "attribute", "name",
				"phase2-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase3ProcWaiting(), source,
				new String[] { "kind", "attribute", "name", "phase3-proc-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase3ServiceTime(), source,
				new String[] { "kind", "attribute", "name", "phase3-service-time", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase3ServiceTimeVariance(), source, new String[] { "kind", "attribute",
				"name", "phase3-service-time-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase3Utilization(), source,
				new String[] { "kind", "attribute", "name", "phase3-utilization", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase3Waiting(), source,
				new String[] { "kind", "attribute", "name", "phase3-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Phase3WaitingVariance(), source, new String[] { "kind", "attribute", "name",
				"phase3-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_ProbExceedMaxServiceTime(), source, new String[] { "kind", "attribute",
				"name", "prob-exceed-max-service-time", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_ProcUtilization(), source,
				new String[] { "kind", "attribute", "name", "proc-utilization", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_ProcWaiting(), source,
				new String[] { "kind", "attribute", "name", "proc-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_RwlockReaderHolding(), source, new String[] { "kind", "attribute", "name",
				"rwlock-reader-holding", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_RwlockReaderUtilization(), source, new String[] { "kind", "attribute",
				"name", "rwlock-reader-utilization", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_RwlockReaderWaiting(), source, new String[] { "kind", "attribute", "name",
				"rwlock-reader-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_RwlockReaderWaitingVariance(), source, new String[] { "kind", "attribute",
				"name", "rwlock-reader-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_RwlockWriterHolding(), source, new String[] { "kind", "attribute", "name",
				"rwlock-writer-holding", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_RwlockWriterUtilization(), source, new String[] { "kind", "attribute",
				"name", "rwlock-writer-utilization", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_RwlockWriterWaiting(), source, new String[] { "kind", "attribute", "name",
				"rwlock-writer-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_RwlockWriterWaitingVariance(), source, new String[] { "kind", "attribute",
				"name", "rwlock-writer-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_SemaphoreUtilization(), source, new String[] { "kind", "attribute", "name",
				"semaphore-utilization", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_SemaphoreWaiting(), source,
				new String[] { "kind", "attribute", "name", "semaphore-waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_SemaphoreWaitingVariance(), source, new String[] { "kind", "attribute",
				"name", "semaphore-waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_ServiceTime(), source,
				new String[] { "kind", "attribute", "name", "service-time", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_ServiceTimeVariance(), source, new String[] { "kind", "attribute", "name",
				"service-time-variance", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_SquaredCoeffVariation(), source, new String[] { "kind", "attribute", "name",
				"squared-coeff-variation", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Throughput(), source,
				new String[] { "kind", "attribute", "name", "throughput", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_ThroughputBound(), source,
				new String[] { "kind", "attribute", "name", "throughput-bound", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Utilization(), source,
				new String[] { "kind", "attribute", "name", "utilization", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_Waiting(), source,
				new String[] { "kind", "attribute", "name", "waiting", "namespace", "##targetNamespace" });
		addAnnotation(getResultConf99Type1_WaitingVariance(), source,
				new String[] { "kind", "attribute", "name", "waiting-variance", "namespace", "##targetNamespace" });
		addAnnotation(resultGeneralTypeEClass, source,
				new String[] { "name", "result-general_._type", "kind", "elementOnly" });
		addAnnotation(getResultGeneralType_MvaInfo(), source,
				new String[] { "kind", "element", "name", "mva-info", "namespace", "##targetNamespace" });
		addAnnotation(getResultGeneralType_ConvVal(), source,
				new String[] { "kind", "attribute", "name", "conv-val", "namespace", "##targetNamespace" });
		addAnnotation(getResultGeneralType_ElapsedTime(), source,
				new String[] { "kind", "attribute", "name", "elapsed-time", "namespace", "##targetNamespace" });
		addAnnotation(getResultGeneralType_Iterations(), source,
		...
		addAnnotation(getResultGeneralType_SolverInfo(), source,
		...
		addAnnotation(getResultGeneralType_UserCpuTime(), source,
				new String[] { "kind", "attribute", "name", "user-cpu-time", "namespace", "##targetNamespace" });
		addAnnotation(getResultGeneralType_Valid(), source,
				new String[] { "kind", "attribute", "name", "valid", "namespace", "##targetNamespace" });
		addAnnotation(runControlTypeEClass, source,
				new String[] { "name", "run-control_._type", "kind", "elementOnly" });
		addAnnotation(getRunControlType_Para(), source,
				new String[] { "kind", "element", "name", "para", "namespace", "##targetNamespace" });
		addAnnotation(rwLockTypeEEnum, source, new String[] { "name", "RWLockType" });
		addAnnotation(rwLockTypeObjectEDataType, source,
				new String[] { "name", "RWLockType:Object", "baseType", "RWLockType" });
		addAnnotation(schedulingTypeEEnum, source, new String[] { "name", "SchedulingType" });
		addAnnotation(schedulingTypeObjectEDataType, source,
				new String[] { "name", "SchedulingType:Object", "baseType", "SchedulingType" });
		addAnnotation(semaphoreTypeEEnum, source, new String[] { "name", "SemaphoreType" });
		addAnnotation(semaphoreTypeObjectEDataType, source,
				new String[] { "name", "SemaphoreType:Object", "baseType", "SemaphoreType" });
		addAnnotation(serviceTypeEClass, source, new String[] { "name", "ServiceType", "kind", "empty" });
		addAnnotation(getServiceType_Name(), source,
				new String[] { "kind", "attribute", "name", "name", "namespace", "##targetNamespace" });
		addAnnotation(singleActivityListTypeEClass, source,
				new String[] { "name", "SingleActivityListType", "kind", "elementOnly" });
		addAnnotation(getSingleActivityListType_Activity(), source,
				new String[] { "kind", "element", "name", "activity", "namespace", "##targetNamespace" });
		addAnnotation(slotTypeEClass, source, new String[] { "name", "SlotType", "kind", "elementOnly" });
		addAnnotation(getSlotType_Interface(), source,
		...
		addAnnotation(srvnFloatEDataType, source, new String[] { "name", "SrvnFloat", "memberTypes",
				"http://www.eclipse.org/emf/2003/XMLType#double http://www.eclipse.org/emf/2003/XMLType#decimal ExtVariable" });
		addAnnotation(srvnNonNegativeIntegerEDataType, source, new String[] { "name", "SrvnNonNegativeInteger",
				"memberTypes", "http://www.eclipse.org/emf/2003/XMLType#nonNegativeInteger ExtVariable" });
		addAnnotation(synchCallTypeEClass, source, new String[] { "name", "synch-call_._type", "kind", "empty" });
		addAnnotation(getSynchCallType_Dest(), source,
				new String[] { "kind", "attribute", "name", "dest", "namespace", "##targetNamespace" });
		addAnnotation(taskActivityGraphEClass, source,
				new String[] { "name", "TaskActivityGraph", "kind", "elementOnly" });
		addAnnotation(getTaskActivityGraph_ReplyEntry(), source,
				new String[] { "kind", "element", "name", "reply-entry", "namespace", "##targetNamespace" });
		addAnnotation(taskOptionTypeEEnum, source, new String[] { "name", "TaskOptionType" });
		addAnnotation(taskOptionTypeObjectEDataType, source,
				new String[] { "name", "TaskOptionType:Object", "baseType", "TaskOptionType" });
		addAnnotation(taskSchedulingTypeEEnum, source, new String[] { "name", "TaskSchedulingType" });
		addAnnotation(taskSchedulingTypeObjectEDataType, source,
				new String[] { "name", "TaskSchedulingType:Object", "baseType", "TaskSchedulingType" });
		addAnnotation(taskTypeEClass, source, new String[] { "name", "TaskType", "kind", "elementOnly" });
		addAnnotation(getTaskType_ResultTask(), source,
				new String[] { "kind", "element", "name", "result-task", "namespace", "##targetNamespace" });
		addAnnotation(getTaskType_ServiceTimeDistribution(), source, new String[] { "kind", "element", "name",
				"service-time-distribution", "namespace", "##targetNamespace" });
		addAnnotation(getTaskType_FanOut(), source,
				new String[] { "kind", "element", "name", "fan-out", "namespace", "##targetNamespace" });
		addAnnotation(getTaskType_FanIn(), source,
				new String[] { "kind", "element", "name", "fan-in", "namespace", "##targetNamespace" });
		addAnnotation(getTaskType_Entry(), source,
		...
		addAnnotation(getTaskType_TaskActivities(), source,
				new String[] { "kind", "element", "name", "task-activities", "namespace", "##targetNamespace" });
		addAnnotation(getTaskType_ActivityGraph(), source,
				new String[] { "kind", "attribute", "name", "activity-graph", "namespace", "##targetNamespace" });
		addAnnotation(getTaskType_Initially(), source,
				new String[] { "kind", "attribute", "name", "initially", "namespace", "##targetNamespace" });
		addAnnotation(getTaskType_Multiplicity(), source,
				new String[] { "kind", "attribute", "name", "multiplicity", "namespace", "##targetNamespace" });
		addAnnotation(getTaskType_Name(), source,
				new String[] { "kind", "attribute", "name", "name", "namespace", "##targetNamespace" });
		addAnnotation(getTaskType_Priority(), source,
				new String[] { "kind", "attribute", "name", "priority", "namespace", "##targetNamespace" });
		addAnnotation(getTaskType_QueueLength(), source,
				new String[] { "kind", "attribute", "name", "queue-length", "namespace", "##targetNamespace" });
		addAnnotation(getTaskType_Replication(), source,
				new String[] { "kind", "attribute", "name", "replication", "namespace", "##targetNamespace" });
		addAnnotation(getTaskType_Scheduling(), source,
				new String[] { "kind", "attribute", "name", "scheduling", "namespace", "##targetNamespace" });
		addAnnotation(getTaskType_ThinkTime(), source,
				new String[] { "kind", "attribute", "name", "think-time", "namespace", "##targetNamespace" });
		...
		addAnnotation(validTypeEEnum, source, new String[] { "name", "valid_._type" });
		addAnnotation(validTypeObjectEDataType, source,
