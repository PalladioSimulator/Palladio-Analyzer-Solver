...
public class GroupTypeImpl extends MinimalEObjectImpl.Container implements GroupType {
	...
	public EList<OutputResultType> getResultGroup() {
		if (resultGroup == null) {
			resultGroup = new EObjectContainmentEList<OutputResultType>(OutputResultType.class, this, LqnPackage.GROUP_TYPE__RESULT_GROUP);
		}
		return resultGroup;
	}
	...
	public void setCap(boolean newCap) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.GROUP_TYPE__CAP, oldCap, cap, !oldCapESet));
	}
	...
	public void unsetCap() {
		...
		capESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LqnPackage.GROUP_TYPE__CAP, oldCap, CAP_EDEFAULT, oldCapESet));
	}
	...
	public String toString() {
		...
		result.append(" (cap: ");
		if (capESet) result.append(cap); else result.append("<unset>");
		result.append(", name: ");
		result.append(name);
		result.append(", share: ");
		result.append(share);
