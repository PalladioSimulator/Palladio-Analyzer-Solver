 ...
 * </li>
 * <li>{@link org.palladiosimulator.solver.lqn.impl.TaskTypeImpl#getServiceTimeDistribution <em>
...
public class TaskTypeImpl extends MinimalEObjectImpl.Container implements TaskType {
     ...
     * @ordered
     */
    protected static final Object MULTIPLICITY_EDEFAULT = LqnFactory.eINSTANCE.createFromString(
            LqnPackage.eINSTANCE.getSrvnNonNegativeInteger(), "1");
    ...
    public EList<FanOutType> getFanOut() {
        if (this.fanOut == null)
        {
            this.fanOut = new EObjectContainmentEList<FanOutType>(FanOutType.class, this, LqnPackage.TASK_TYPE__FAN_OUT);
        }
        return this.fanOut;
    }
    ...
    public EList<FanInType> getFanIn() {
        if (this.fanIn == null)
        {
            this.fanIn = new EObjectContainmentEList<FanInType>(FanInType.class, this, LqnPackage.TASK_TYPE__FAN_IN);
        }
        return this.fanIn;
    }
     ...
     */
    @Override
    public void setInitially(final BigInteger newInitially) {
        final BigInteger oldInitially = this.initially;
        this.initially = newInitially;
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.TASK_TYPE__INITIALLY, oldInitially,
                    this.initially));
        }
    }
     ...
     */
    @Override
    public void setMultiplicity(final Object newMultiplicity) {
        final Object oldMultiplicity = this.multiplicity;
    ...
    public NotificationChain eInverseRemove(final InternalEObject otherEnd, final int featureID,
        ...
        case LqnPackage.TASK_TYPE__FAN_OUT:
            return ((InternalEList<?>) this.getFanOut()).basicRemove(otherEnd, msgs);
        case LqnPackage.TASK_TYPE__FAN_IN:
            return ((InternalEList<?>) this.getFanIn()).basicRemove(otherEnd, msgs);
    ...
    public void eSet(final int featureID, final Object newValue) {
        ...
        case LqnPackage.TASK_TYPE__SERVICE_TIME_DISTRIBUTION:
            ...
            return;
        case LqnPackage.TASK_TYPE__FAN_OUT:
            this.getFanOut().clear();
            this.getFanOut().addAll((Collection<? extends FanOutType>) newValue);
            return;
        case LqnPackage.TASK_TYPE__FAN_IN:
            this.getFanIn().clear();
            this.getFanIn().addAll((Collection<? extends FanInType>) newValue);
            return;
        case LqnPackage.TASK_TYPE__ENTRY:
            this.getEntry().clear();
        ...
        case LqnPackage.TASK_TYPE__ACTIVITY_GRAPH:
            ...
            return;
        case LqnPackage.TASK_TYPE__INITIALLY:
            this.setInitially((BigInteger) newValue);
            return;
        case LqnPackage.TASK_TYPE__MULTIPLICITY:
            this.setMultiplicity(newValue);
            return;
        case LqnPackage.TASK_TYPE__NAME:
    ...
    public void eUnset(final int featureID) {
        ...
        case LqnPackage.TASK_TYPE__ACTIVITY_GRAPH:
            ...
            return;
        case LqnPackage.TASK_TYPE__INITIALLY:
            this.setInitially(INITIALLY_EDEFAULT);
            return;
        case LqnPackage.TASK_TYPE__MULTIPLICITY:
    ...
    public boolean eIsSet(final int featureID) {
        ...
        case LqnPackage.TASK_TYPE__FAN_OUT:
            return this.fanOut != null && !this.fanOut.isEmpty();
        case LqnPackage.TASK_TYPE__FAN_IN:
            return this.fanIn != null && !this.fanIn.isEmpty();
        case LqnPackage.TASK_TYPE__ENTRY:
        ...
        case LqnPackage.TASK_TYPE__INITIALLY:
            return INITIALLY_EDEFAULT == null ? this.initially != null : !INITIALLY_EDEFAULT.equals(this.initially);
        case LqnPackage.TASK_TYPE__MULTIPLICITY:
