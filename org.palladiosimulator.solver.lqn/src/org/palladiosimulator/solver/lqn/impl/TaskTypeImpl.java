...
public class TaskTypeImpl extends MinimalEObjectImpl.Container implements TaskType {
	 ...
	 * @ordered
	 */
	protected static final Object MULTIPLICITY_EDEFAULT = LqnFactory.eINSTANCE.createFromString(LqnPackage.eINSTANCE.getSrvnNonNegativeInteger(), "1");
	...
	public EList<OutputDistributionType> getServiceTimeDistribution() {
		if (serviceTimeDistribution == null) {
			serviceTimeDistribution = new EObjectContainmentEList<OutputDistributionType>(OutputDistributionType.class, this, LqnPackage.TASK_TYPE__SERVICE_TIME_DISTRIBUTION);
		}
	...
	public void setInitially(BigInteger newInitially) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.TASK_TYPE__INITIALLY, oldInitially, initially));
	}
