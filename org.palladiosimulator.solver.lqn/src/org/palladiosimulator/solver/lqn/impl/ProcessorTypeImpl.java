...
public class ProcessorTypeImpl extends MinimalEObjectImpl.Container implements ProcessorType {
    ...
    public EList<GroupType> getGroup() {
        if (this.group == null)
        {
            this.group = new EObjectContainmentEList<GroupType>(GroupType.class, this, LqnPackage.PROCESSOR_TYPE__GROUP);
        }
        return this.group;
    }
    ...
    public void eSet(final int featureID, final Object newValue) {
        ...
        case LqnPackage.PROCESSOR_TYPE__GROUP:
            this.getGroup().clear();
            this.getGroup().addAll((Collection<? extends GroupType>) newValue);
            return;
        case LqnPackage.PROCESSOR_TYPE__TASK:
            this.getTask().clear();
