...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Activity Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class ActivityTypeImpl extends EObjectImpl implements ActivityType {
    ...
    public void setName(final String newName) {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.ACTIVITY_TYPE__NAME, oldName,
                    this.name));
        }
    }
