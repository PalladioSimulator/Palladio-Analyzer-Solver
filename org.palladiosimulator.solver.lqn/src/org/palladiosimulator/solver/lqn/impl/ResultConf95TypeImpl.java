 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.solver.lqn.impl.ResultConf95TypeImpl#getJoinVariance <em>Join Variance</em>}</li>
 *   <li>{@link org.palladiosimulator.solver.lqn.impl.ResultConf95TypeImpl#getJoinWaiting <em>Join Waiting</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResultConf95TypeImpl extends MinimalEObjectImpl.Container implements ResultConf95Type {
	...
	public void setJoinVariance(double newJoinVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.RESULT_CONF95_TYPE__JOIN_VARIANCE, oldJoinVariance, joinVariance, !oldJoinVarianceESet));
	}
	...
	public void unsetJoinVariance() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LqnPackage.RESULT_CONF95_TYPE__JOIN_VARIANCE, oldJoinVariance, JOIN_VARIANCE_EDEFAULT, oldJoinVarianceESet));
	}
	...
	public void setJoinWaiting(double newJoinWaiting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.RESULT_CONF95_TYPE__JOIN_WAITING, oldJoinWaiting, joinWaiting, !oldJoinWaitingESet));
	}
	...
	public void unsetJoinWaiting() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LqnPackage.RESULT_CONF95_TYPE__JOIN_WAITING, oldJoinWaiting, JOIN_WAITING_EDEFAULT, oldJoinWaitingESet));
	}
