...
public class ResultConf99TypeImpl extends MinimalEObjectImpl.Container implements ResultConf99Type {
	...
	public void setJoinVariance(double newJoinVariance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.RESULT_CONF99_TYPE__JOIN_VARIANCE, oldJoinVariance, joinVariance, !oldJoinVarianceESet));
	}
	...
	public void unsetJoinVariance() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LqnPackage.RESULT_CONF99_TYPE__JOIN_VARIANCE, oldJoinVariance, JOIN_VARIANCE_EDEFAULT, oldJoinVarianceESet));
	}
	...
	public void setJoinWaiting(double newJoinWaiting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.RESULT_CONF99_TYPE__JOIN_WAITING, oldJoinWaiting, joinWaiting, !oldJoinWaitingESet));
	}
	...
	public void unsetJoinWaiting() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LqnPackage.RESULT_CONF99_TYPE__JOIN_WAITING, oldJoinWaiting, JOIN_WAITING_EDEFAULT, oldJoinWaitingESet));
	}
