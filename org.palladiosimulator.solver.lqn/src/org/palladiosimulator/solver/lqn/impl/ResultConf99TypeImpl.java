 ...
 * <ul>
 * <li>{@link org.palladiosimulator.solver.lqn.impl.ResultConf99TypeImpl#getJoinVariance <em>Join
 * Variance</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.impl.ResultConf99TypeImpl#getJoinWaiting <em>Join
 * Waiting</em>}</li>
 * </ul>
 * </p>
 *
...
public class ResultConf99TypeImpl extends MinimalEObjectImpl.Container implements ResultConf99Type {
    ...
    public void setJoinVariance(final double newJoinVariance) {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.RESULT_CONF99_TYPE__JOIN_VARIANCE,
    ...
    public void unsetJoinVariance() {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.UNSET, LqnPackage.RESULT_CONF99_TYPE__JOIN_VARIANCE,
    ...
    public void setJoinWaiting(final double newJoinWaiting) {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.RESULT_CONF99_TYPE__JOIN_WAITING,
    ...
    public void unsetJoinWaiting() {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.UNSET, LqnPackage.RESULT_CONF99_TYPE__JOIN_WAITING,
