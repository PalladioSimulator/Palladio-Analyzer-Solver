 ...
 * Waiting</em>}</li>
 * <li>{@link org.palladiosimulator.solver.lqn.impl.ResultConf99TypeImpl#getWaiting <em>Waiting
 * </em>}</li>
 * </ul>
 * </p>
 *
...
public class ResultConf99TypeImpl extends EObjectImpl implements ResultConf99Type {
    ...
    public void setWaiting(final Object newWaiting) {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.RESULT_CONF99_TYPE__WAITING,
                    oldWaiting,
                    this.waiting));
        }
    }
