...
public class HistogramBinTypeImpl extends MinimalEObjectImpl.Container implements HistogramBinType {
	...
	/**
	 * This is true if the Begin attribute has been set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	/**
	 * This is true if the Conf95 attribute has been set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	/**
	 * This is true if the Conf99 attribute has been set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	public void setBegin(double newBegin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.HISTOGRAM_BIN_TYPE__BEGIN, oldBegin, begin, !oldBeginESet));
	}
	...
	public void unsetBegin() {
		...
		beginESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LqnPackage.HISTOGRAM_BIN_TYPE__BEGIN, oldBegin, BEGIN_EDEFAULT, oldBeginESet));
	}
	...
	public void setConf95(double newConf95) {
		...
		conf95ESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.HISTOGRAM_BIN_TYPE__CONF95, oldConf95, conf95, !oldConf95ESet));
	}
	...
	public void unsetConf95() {
		...
		conf95ESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LqnPackage.HISTOGRAM_BIN_TYPE__CONF95, oldConf95, CONF95_EDEFAULT, oldConf95ESet));
	}
	...
	public void setConf99(double newConf99) {
		...
		conf99ESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.HISTOGRAM_BIN_TYPE__CONF99, oldConf99, conf99, !oldConf99ESet));
	}
	...
	public void unsetConf99() {
		...
		conf99ESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LqnPackage.HISTOGRAM_BIN_TYPE__CONF99, oldConf99, CONF99_EDEFAULT, oldConf99ESet));
	}
	...
	public void setEnd(double newEnd) {
		...
		endESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.HISTOGRAM_BIN_TYPE__END, oldEnd, end, !oldEndESet));
	}
	...
	public void unsetEnd() {
		...
		endESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LqnPackage.HISTOGRAM_BIN_TYPE__END, oldEnd, END_EDEFAULT, oldEndESet));
	}
	...
	public void setProb(double newProb) {
		...
		probESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.HISTOGRAM_BIN_TYPE__PROB, oldProb, prob, !oldProbESet));
	}
	...
	public void unsetProb() {
		...
		probESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LqnPackage.HISTOGRAM_BIN_TYPE__PROB, oldProb, PROB_EDEFAULT, oldProbESet));
	}
	...
	public String toString() {
		...
		result.append(" (begin: ");
		if (beginESet) result.append(begin); else result.append("<unset>");
		result.append(", conf95: ");
		if (conf95ESet) result.append(conf95); else result.append("<unset>");
		result.append(", conf99: ");
		if (conf99ESet) result.append(conf99); else result.append("<unset>");
		result.append(", end: ");
