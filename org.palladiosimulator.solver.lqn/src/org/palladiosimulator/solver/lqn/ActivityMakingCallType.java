 ...
 * <ul>
 * <li>{@link org.palladiosimulator.solver.lqn.ActivityMakingCallType#getCallsMean <em>Calls Mean
 * </em>}</li>
 * </ul>
 * </p>
 *
...
public interface ActivityMakingCallType extends MakingCallType {
    /**
     * Returns the value of the '<em><b>Calls Mean</b></em>' attribute. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Calls Mean</em>' attribute isn't clear, there really should be
     ...
     * <em>Calls Mean</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Calls Mean</em>' attribute.
     * @see #getCallsMean()
     * @generated
     */
