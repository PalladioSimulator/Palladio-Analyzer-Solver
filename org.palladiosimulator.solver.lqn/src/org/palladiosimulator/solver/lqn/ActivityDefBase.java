...
public interface ActivityDefBase extends EObject {
     ...
     * @see org.palladiosimulator.solver.lqn.LqnPackage#getActivityDefBase_ResultJoinDelay()
     * @model containment="true" extendedMetaData=
     *        "kind='element' name='result-join-delay' namespace='##targetNamespace'"
     * @generated
     */
    EList<OutputResultForwardingANDJoinDelay> getResultJoinDelay();

    /**
     * Returns the value of the '<em><b>Result Forwarding</b></em>' containment reference list. The
     * list contents are of type
     * {@link org.palladiosimulator.solver.lqn.OutputResultForwardingANDJoinDelay}. <!--
     * begin-user-doc -->
     * <p>
     ...
     * @see org.palladiosimulator.solver.lqn.LqnPackage#getActivityDefBase_ResultForwarding()
     * @model containment="true" extendedMetaData=
     *        "kind='element' name='result-forwarding' namespace='##targetNamespace'"
     * @generated
     */
     ...
     * @model containment="true" extendedMetaData=
     *        "kind='element' name='result-activity' namespace='##targetNamespace'"
     * @generated
     */
