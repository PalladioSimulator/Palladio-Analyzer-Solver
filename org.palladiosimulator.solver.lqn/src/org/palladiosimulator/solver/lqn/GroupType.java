...
public interface GroupType extends EObject {
	/**
	 * Returns the value of the '<em><b>Result Group</b></em>' containment reference list.
	 * The list contents are of type {@link org.palladiosimulator.solver.lqn.OutputResultType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Result Group</em>' containment reference list isn't clear,
