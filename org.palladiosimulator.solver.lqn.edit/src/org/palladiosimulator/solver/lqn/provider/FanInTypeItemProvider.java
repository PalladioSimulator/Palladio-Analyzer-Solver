...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.solver.lqn.FanInType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FanInTypeItemProvider 
	 ...
	 * @generated
	 */
	public FanInTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FanInType_source_feature", "_UI_FanInType_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FanInType_value_feature", "_UI_FanInType_type"),
	...
	public String getText(Object object) {
		String label = ((FanInType)object).getSource();
		return label == null || label.length() == 0 ?
			getString("_UI_FanInType_type") :
			getString("_UI_FanInType_type") + " " + label;
	}
