...
public class OutputEntryDistributionTypeItemProvider extends OutputDistributionTypeItemProvider {
    ...
    public String getText(final Object object) {
        final OutputEntryDistributionType outputEntryDistributionType = (OutputEntryDistributionType) object;
        return this.getString("_UI_OutputEntryDistributionType_type") + " " + outputEntryDistributionType.getBinSize();
    }
