...
IItemPropertySource {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null)
        {
            ...
            this.childrenFeatures.add(LqnPackage.Literals.RESULT_GENERAL_TYPE__MVA_INFO);
        }
    ...
    public String getText(final Object object) {
        final ResultGeneralType resultGeneralType = (ResultGeneralType) object;
        return this.getString("_UI_ResultGeneralType_type") + " " + resultGeneralType.getConvVal();
    }
