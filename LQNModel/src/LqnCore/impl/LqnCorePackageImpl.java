...
public class LqnCorePackageImpl extends EPackageImpl implements LqnCorePackage {
     ...
     * 
     * <p>This method is used to initialize {@link LqnCorePackage#eINSTANCE} when that field is accessed.
	...
	public static LqnCorePackage init() {
        ...
        LqnCorePackageImpl theLqnCorePackage = (LqnCorePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof LqnCorePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new LqnCorePackageImpl());
        ...
        EPackage.Registry.INSTANCE.put(LqnCorePackage.eNS_URI, theLqnCorePackage);
