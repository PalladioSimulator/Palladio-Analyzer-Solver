...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Task Activity Graph</b></em>
 * '. <!-- end-user-doc -->
 *
 * <p>
...
public interface TaskActivityGraph extends ActivityGraphBase {
    ...
    /**
     * Returns the value of the '<em><b>Reply Entry</b></em>' containment reference list. The list
     * contents are of type {@link org.palladiosimulator.solver.lqn.ReplyEntryType}. <!--
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Reply Entry</em>' containment reference list isn't clear, there
     ...
     *        "kind='element' name='reply-entry' namespace='##targetNamespace'"
     * @generated
     */
