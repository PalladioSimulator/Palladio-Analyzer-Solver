...
public class AsynchCallTypeImpl extends EObjectImpl implements AsynchCallType {
    ...
    public void unsetFanin() {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.UNSET, LqnPackage.ASYNCH_CALL_TYPE__FANIN, oldFanin,
    ...
    public void setFanout(final int newFanout) {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET, LqnPackage.ASYNCH_CALL_TYPE__FANOUT, oldFanout,
