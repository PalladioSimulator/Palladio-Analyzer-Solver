...
public class lqnAdapterFactory extends AdapterFactoryImpl {
    ...
    protected lqnSwitch<Adapter> modelSwitch = new lqnSwitch<Adapter>() {
        ...
        @Override
        public Adapter caseOutputResultForwardingANDJoinDelay(final OutputResultForwardingANDJoinDelay object) {
            return lqnAdapterFactory.this.createOutputResultForwardingANDJoinDelayAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '
     * {@link org.palladiosimulator.solver.lqn.LqnCoreType <em>Lqn Core Type</em>}'. <!--
     * begin-user-doc --> This default implementation returns null so that we can easily ignore
     * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
     * end-user-doc -->
     *
    ...
    /**
     * Creates a new adapter for an object of class '
     * {@link org.palladiosimulator.solver.lqn.LqnModelType <em>Lqn Model Type</em>}'. <!--
     * begin-user-doc --> This default implementation returns null so that we can easily ignore
     * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
     * end-user-doc -->
     *
     ...
     * <em>Output Result Forwarding AND Join Delay</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's useful to ignore a case
     * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
     *
     * @return the new adapter.
