 ...
 * @generated
 */
public class ComputedAllocationActionBarContributor extends EditingDomainActionBarContributor
    ...
    protected IAction showPropertiesViewAction = new Action(
        ...
        public void run() {
            try {
                ComputedAllocationActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
    ...
    protected IAction refreshViewerAction = new Action(
        ...
        public boolean isEnabled() {
            return ComputedAllocationActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (ComputedAllocationActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) ComputedAllocationActionBarContributor.this.activeEditorPart)
                        .getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                ...
                "org.palladiosimulator.solver.context.computed_allocationMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                ContextEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
