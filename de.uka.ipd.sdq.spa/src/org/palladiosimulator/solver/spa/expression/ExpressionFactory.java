...
public interface ExpressionFactory extends EFactory {
     ...
     * @generated
     */
    ExpressionFactory eINSTANCE = org.palladiosimulator.solver.spa.expression.impl.ExpressionFactoryImpl.init();
    ...
    /**
     * Returns a new object of class '<em>Alternative</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
