 ...
 * <ul>
 * <li>{@link org.palladiosimulator.solver.spa.expression.impl.AcquireImpl#getResource <em>Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AcquireImpl extends TerminalImpl implements Acquire {
        ...
        if (resource != null && resource.eIsProxy()) {
            ...
            if (resource != oldResource) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExpressionPackage.ACQUIRE__RESOURCE,
    ...
    public void setResource(PassiveResource newResource) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.ACQUIRE__RESOURCE, oldResource,
                    resource));
    }
